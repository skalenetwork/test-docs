...
[SkaleManager-constructor-address-]: #SkaleManager-constructor-address-
[SkaleManager-tokenFallback-address-uint256-bytes-]: #SkaleManager-tokenFallback-address-uint256-bytes-
[SkaleManager-initWithdrawDeposit-uint256-]: #SkaleManager-initWithdrawDeposit-uint256-
[SkaleManager-completeWithdrawdeposit-uint256-]: #SkaleManager-completeWithdrawdeposit-uint256-
...
[SkaleManager-sendVerdict-uint256-uint256-uint32-uint32-]: #SkaleManager-sendVerdict-uint256-uint256-uint32-uint32-
[SkaleManager-sendVerdicts-uint256-uint256---uint32---uint32---]: #SkaleManager-sendVerdicts-uint256-uint256---uint32---uint32---
[SkaleManager-getBounty-uint256-]: #SkaleManager-getBounty-uint256-
[SkaleManager-manageBounty-address-uint256-uint32-uint32-address-]: #SkaleManager-manageBounty-address-uint256-uint32-uint32-address-
[SkaleManager-fallbackOperationTypeConvert-bytes-]: #SkaleManager-fallbackOperationTypeConvert-bytes-
[Ownable-constructor--]: #Ownable-constructor--
[Ownable-transferOwnership-address-]: #Ownable-transferOwnership-address-
[SkaleManager-BountyGot-uint256-address-uint32-uint32-uint256-uint32-uint256-]: #SkaleManager-BountyGot-uint256-address-uint32-uint32-uint256-uint32-uint256-
...
## <span id="SkaleManager"></span> `SkaleManager`
...
- [`constructor(address newContractsAddress)`][SkaleManager-constructor-address-]
- [`tokenFallback(address from, uint256 value, bytes data)`][SkaleManager-tokenFallback-address-uint256-bytes-]
- [`initWithdrawDeposit(uint256 nodeIndex)`][SkaleManager-initWithdrawDeposit-uint256-]
- [`completeWithdrawdeposit(uint256 nodeIndex)`][SkaleManager-completeWithdrawdeposit-uint256-]
- [`deleteNode(uint256 nodeIndex)`][SkaleManager-deleteNode-uint256-]
- [`deleteNodeByRoot(uint256 nodeIndex)`][SkaleManager-deleteNodeByRoot-uint256-]
- [`deleteSchain(string name)`][SkaleManager-deleteSchain-string-]
- [`deleteSchainByRoot(string name)`][SkaleManager-deleteSchainByRoot-string-]
- [`sendVerdict(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency)`][SkaleManager-sendVerdict-uint256-uint256-uint32-uint32-]
- [`sendVerdicts(uint256 fromValidatorIndex, uint256[] toNodeIndexes, uint32[] downtimes, uint32[] latencies)`][SkaleManager-sendVerdicts-uint256-uint256---uint32---uint32---]
- [`getBounty(uint256 nodeIndex)`][SkaleManager-getBounty-uint256-]
- [`manageBounty(address from, uint256 nodeIndex, uint32 downtime, uint32 latency, address nodesDataAddress)`][SkaleManager-manageBounty-address-uint256-uint32-uint32-address-]
- [`fallbackOperationTypeConvert(bytes data)`][SkaleManager-fallbackOperationTypeConvert-bytes-]
- [`constructor()`][Ownable-constructor--]
- [`transferOwnership(address newOwner)`][Ownable-transferOwnership-address-]
- [`BountyGot(uint256 nodeIndex, address owner, uint32 averageDowntime, uint32 averageLatency, uint256 bounty, uint32 time, uint256 gasSpend)`][SkaleManager-BountyGot-uint256-address-uint32-uint32-uint256-uint32-uint256-]
### <span id="SkaleManager-constructor-address-"></span> `constructor(address newContractsAddress)` (public)



### <span id="SkaleManager-tokenFallback-address-uint256-bytes-"></span> `tokenFallback(address from, uint256 value, bytes data)` (external)



### <span id="SkaleManager-initWithdrawDeposit-uint256-"></span> `initWithdrawDeposit(uint256 nodeIndex)` (external)



### <span id="SkaleManager-completeWithdrawdeposit-uint256-"></span> `completeWithdrawdeposit(uint256 nodeIndex)` (external)



### <span id="SkaleManager-deleteNode-uint256-"></span> `deleteNode(uint256 nodeIndex)` (external)



### <span id="SkaleManager-deleteNodeByRoot-uint256-"></span> `deleteNodeByRoot(uint256 nodeIndex)` (external)



### <span id="SkaleManager-deleteSchain-string-"></span> `deleteSchain(string name)` (external)



### <span id="SkaleManager-deleteSchainByRoot-string-"></span> `deleteSchainByRoot(string name)` (external)



### <span id="SkaleManager-sendVerdict-uint256-uint256-uint32-uint32-"></span> `sendVerdict(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency)` (external)



### <span id="SkaleManager-sendVerdicts-uint256-uint256---uint32---uint32---"></span> `sendVerdicts(uint256 fromValidatorIndex, uint256[] toNodeIndexes, uint32[] downtimes, uint32[] latencies)` (external)



### <span id="SkaleManager-getBounty-uint256-"></span> `getBounty(uint256 nodeIndex)` (external)



### <span id="SkaleManager-manageBounty-address-uint256-uint32-uint32-address-"></span> `manageBounty(address from, uint256 nodeIndex, uint32 downtime, uint32 latency, address nodesDataAddress) → uint256` (internal)



### <span id="SkaleManager-fallbackOperationTypeConvert-bytes-"></span> `fallbackOperationTypeConvert(bytes data) → enum SkaleManager.TransactionOperation` (internal)



### <span id="SkaleManager-BountyGot-uint256-address-uint32-uint32-uint256-uint32-uint256-"></span> `BountyGot(uint256 nodeIndex, address owner, uint32 averageDowntime, uint32 averageLatency, uint256 bounty, uint32 time, uint256 gasSpend)`
