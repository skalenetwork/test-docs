...
[GroupsData-constructor-string-address-]: #GroupsData-constructor-string-address-
...
## <span id="GroupsData"></span> `GroupsData`
...
- [`constructor(string newExecutorName, address newContractsAddress)`][GroupsData-constructor-string-address-]
...
### <span id="GroupsData-constructor-string-address-"></span> `constructor(string newExecutorName, address newContractsAddress)` (public)

constructor in Permissions approach


### <span id="GroupsData-addGroup-bytes32-uint256-bytes32-"></span> `addGroup(bytes32 groupIndex, uint256 amountOfNodes, bytes32 data)` (external)

addGroup - creates and adds new Group to mapping
function could be run only by executor


### <span id="GroupsData-setException-bytes32-uint256-"></span> `setException(bytes32 groupIndex, uint256 nodeIndex)` (external)

setException - sets a Node like exception
function could be run only by executor


### <span id="GroupsData-setPublicKey-bytes32-uint256-uint256-uint256-uint256-"></span> `setPublicKey(bytes32 groupIndex, uint256 publicKeyx1, uint256 publicKeyy1, uint256 publicKeyx2, uint256 publicKeyy2)` (external)

setPublicKey - sets BLS master public key
function could be run only by SkaleDKG


### <span id="GroupsData-setNodeInGroup-bytes32-uint256-"></span> `setNodeInGroup(bytes32 groupIndex, uint256 nodeIndex)` (external)

setNodeInGroup - adds Node to Group
function could be run only by executor


### <span id="GroupsData-removeNodeFromGroup-uint256-bytes32-"></span> `removeNodeFromGroup(uint256 indexOfNode, bytes32 groupIndex)` (external)

removeNodeFromGroup - removes Node out of the Group
function could be run only by executor


### <span id="GroupsData-removeAllNodesInGroup-bytes32-"></span> `removeAllNodesInGroup(bytes32 groupIndex)` (external)

removeAllNodesInGroup - removes all added Nodes out the Group
function could be run only by executor


### <span id="GroupsData-setNodesInGroup-bytes32-uint256---"></span> `setNodesInGroup(bytes32 groupIndex, uint256[] nodesInGroup)` (external)

setNodesInGroup - adds Nodes to Group
function could be run only by executor


### <span id="GroupsData-setGroupFailedDKG-bytes32-"></span> `setGroupFailedDKG(bytes32 groupIndex)` (external)



### <span id="GroupsData-removeGroup-bytes32-"></span> `removeGroup(bytes32 groupIndex)` (external)

removeGroup - remove Group from storage
function could be run only be executor


### <span id="GroupsData-removeExceptionNode-bytes32-uint256-"></span> `removeExceptionNode(bytes32 groupIndex, uint256 nodeIndex)` (external)

removeExceptionNode - remove exception Node from Group
function could be run only by executor


### <span id="GroupsData-isGroupActive-bytes32-"></span> `isGroupActive(bytes32 groupIndex) → bool` (external)

isGroupActive - checks is Group active


### <span id="GroupsData-isExceptionNode-bytes32-uint256-"></span> `isExceptionNode(bytes32 groupIndex, uint256 nodeIndex) → bool` (external)

isExceptionNode - checks is Node - exception at given Group


### <span id="GroupsData-getGroupsPublicKey-bytes32-"></span> `getGroupsPublicKey(bytes32 groupIndex) → uint256, uint256, uint256, uint256` (external)

getGroupsPublicKey - shows Groups public key


### <span id="GroupsData-getNodesInGroup-bytes32-"></span> `getNodesInGroup(bytes32 groupIndex) → uint256[]` (external)

getNodesInGroup - shows Nodes in Group


### <span id="GroupsData-getGroupData-bytes32-"></span> `getGroupData(bytes32 groupIndex) → bytes32` (external)

getGroupsData - shows Groups extra data


### <span id="GroupsData-getRecommendedNumberOfNodes-bytes32-"></span> `getRecommendedNumberOfNodes(bytes32 groupIndex) → uint256` (external)

getRecommendedNumberOfNodes - shows recommended number of Nodes


### <span id="GroupsData-getNumberOfNodesInGroup-bytes32-"></span> `getNumberOfNodesInGroup(bytes32 groupIndex) → uint256` (external)
