...
[Pricing-constructor-address-]: #Pricing-constructor-address-
...
- [`constructor(address newContractsAddress)`][Pricing-constructor-address-]
- [`initNodes()`][Pricing-initNodes--]
- [`adjustPrice()`][Pricing-adjustPrice--]
- [`checkAllNodes()`][Pricing-checkAllNodes--]
- [`getTotalLoadPercentage()`][Pricing-getTotalLoadPercentage--]
- [`constructor()`][Ownable-constructor--]
- [`transferOwnership(address newOwner)`][Ownable-transferOwnership-address-]
### <span id="Pricing-constructor-address-"></span> `constructor(address newContractsAddress)` (public)



### <span id="Pricing-initNodes--"></span> `initNodes()` (external)



### <span id="Pricing-adjustPrice--"></span> `adjustPrice()` (external)



### <span id="Pricing-checkAllNodes--"></span> `checkAllNodes()` (public)



### <span id="Pricing-getTotalLoadPercentage--"></span> `getTotalLoadPercentage() → uint256` (public)
