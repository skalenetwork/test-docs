...
[ConstantsHolder-constructor-address-]: #ConstantsHolder-constructor-address-
...
## <span id="ConstantsHolder"></span> `ConstantsHolder`
...
- [`constructor(address contractsAddress)`][ConstantsHolder-constructor-address-]
- [`setPeriods(uint32 newRewardPeriod, uint32 newDeltaPeriod)`][ConstantsHolder-setPeriods-uint32-uint32-]
- [`setCheckTime(uint8 newCheckTime)`][ConstantsHolder-setCheckTime-uint8-]
- [`setLastTimeUnderloaded()`][ConstantsHolder-setLastTimeUnderloaded--]
- [`setLastTimeOverloaded()`][ConstantsHolder-setLastTimeOverloaded--]
- [`setLatency(uint32 newAllowableLatency)`][ConstantsHolder-setLatency-uint32-]
...
### <span id="ConstantsHolder-constructor-address-"></span> `constructor(address contractsAddress)` (public)

constructor in Permissions approach


### <span id="ConstantsHolder-setPeriods-uint32-uint32-"></span> `setPeriods(uint32 newRewardPeriod, uint32 newDeltaPeriod)` (external)



### <span id="ConstantsHolder-setCheckTime-uint8-"></span> `setCheckTime(uint8 newCheckTime)` (external)



### <span id="ConstantsHolder-setLastTimeUnderloaded--"></span> `setLastTimeUnderloaded()` (external)



### <span id="ConstantsHolder-setLastTimeOverloaded--"></span> `setLastTimeOverloaded()` (external)



### <span id="ConstantsHolder-setLatency-uint32-"></span> `setLatency(uint32 newAllowableLatency)` (external)
