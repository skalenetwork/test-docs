...
[ValidatorsData-constructor-string-address-]: #ValidatorsData-constructor-string-address-
[ValidatorsData-addValidatedNode-bytes32-bytes32-]: #ValidatorsData-addValidatedNode-bytes32-bytes32-
[ValidatorsData-addVerdict-bytes32-uint32-uint32-]: #ValidatorsData-addVerdict-bytes32-uint32-uint32-
[ValidatorsData-removeValidatedNode-bytes32-uint256-]: #ValidatorsData-removeValidatedNode-bytes32-uint256-
[ValidatorsData-removeAllValidatedNodes-bytes32-]: #ValidatorsData-removeAllValidatedNodes-bytes32-
[ValidatorsData-removeAllVerdicts-bytes32-]: #ValidatorsData-removeAllVerdicts-bytes32-
[ValidatorsData-getValidatedArray-bytes32-]: #ValidatorsData-getValidatedArray-bytes32-
[ValidatorsData-getLengthOfMetrics-bytes32-]: #ValidatorsData-getLengthOfMetrics-bytes32-
...
## <span id="ValidatorsData"></span> `ValidatorsData`
...
- [`constructor(string newExecutorName, address newContractsAddress)`][ValidatorsData-constructor-string-address-]
- [`addValidatedNode(bytes32 validatorIndex, bytes32 data)`][ValidatorsData-addValidatedNode-bytes32-bytes32-]
- [`addVerdict(bytes32 validatorIndex, uint32 downtime, uint32 latency)`][ValidatorsData-addVerdict-bytes32-uint32-uint32-]
- [`removeValidatedNode(bytes32 validatorIndex, uint256 indexOfValidatedNode)`][ValidatorsData-removeValidatedNode-bytes32-uint256-]
- [`removeAllValidatedNodes(bytes32 validatorIndex)`][ValidatorsData-removeAllValidatedNodes-bytes32-]
- [`removeAllVerdicts(bytes32 validatorIndex)`][ValidatorsData-removeAllVerdicts-bytes32-]
- [`getValidatedArray(bytes32 validatorIndex)`][ValidatorsData-getValidatedArray-bytes32-]
- [`getLengthOfMetrics(bytes32 validatorIndex)`][ValidatorsData-getLengthOfMetrics-bytes32-]
...
### <span id="ValidatorsData-constructor-string-address-"></span> `constructor(string newExecutorName, address newContractsAddress)` (public)



### <span id="ValidatorsData-addValidatedNode-bytes32-bytes32-"></span> `addValidatedNode(bytes32 validatorIndex, bytes32 data)` (external)



### <span id="ValidatorsData-addVerdict-bytes32-uint32-uint32-"></span> `addVerdict(bytes32 validatorIndex, uint32 downtime, uint32 latency)` (external)



### <span id="ValidatorsData-removeValidatedNode-bytes32-uint256-"></span> `removeValidatedNode(bytes32 validatorIndex, uint256 indexOfValidatedNode)` (external)



### <span id="ValidatorsData-removeAllValidatedNodes-bytes32-"></span> `removeAllValidatedNodes(bytes32 validatorIndex)` (external)



### <span id="ValidatorsData-removeAllVerdicts-bytes32-"></span> `removeAllVerdicts(bytes32 validatorIndex)` (external)



### <span id="ValidatorsData-getValidatedArray-bytes32-"></span> `getValidatedArray(bytes32 validatorIndex) → bytes32[]` (external)



### <span id="ValidatorsData-getLengthOfMetrics-bytes32-"></span> `getLengthOfMetrics(bytes32 validatorIndex) → uint256` (external)
