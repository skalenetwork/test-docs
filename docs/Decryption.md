...
[Decryption-encrypt-uint256-bytes32-]: #Decryption-encrypt-uint256-bytes32-
[Decryption-decrypt-bytes32-bytes32-]: #Decryption-decrypt-bytes32-bytes32-
[ECDH]: ECDH.md#ECDH
...
## <span id="Decryption"></span> `Decryption`



- [`encrypt(uint256 secretNumber, bytes32 key)`][Decryption-encrypt-uint256-bytes32-]
- [`decrypt(bytes32 ciphertext, bytes32 key)`][Decryption-decrypt-bytes32-bytes32-]
### <span id="Decryption-encrypt-uint256-bytes32-"></span> `encrypt(uint256 secretNumber, bytes32 key) → bytes32 ciphertext` (external)



### <span id="Decryption-decrypt-bytes32-bytes32-"></span> `decrypt(bytes32 ciphertext, bytes32 key) → uint256 secretNumber` (external)
