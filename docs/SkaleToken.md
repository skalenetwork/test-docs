...
[SkaleToken-constructor-address-]: #SkaleToken-constructor-address-
[SkaleToken-mint-address-uint256-]: #SkaleToken-mint-address-uint256-
[SkaleToken-burn-address-uint256-]: #SkaleToken-burn-address-uint256-
[SkaleToken-transferWithData-address-uint256-bytes-]: #SkaleToken-transferWithData-address-uint256-bytes-
...
[StandardToken-transfer-address-uint256-bytes-]: #StandardToken-transfer-address-uint256-bytes-
[ISkaleToken-CAP--]: #ISkaleToken-CAP--
[SkaleToken-Mint-address-uint256-uint32-uint256-]: #SkaleToken-Mint-address-uint256-uint32-uint256-
[SkaleToken-Burn-address-uint256-uint32-uint256-]: #SkaleToken-Burn-address-uint256-uint32-uint256-
...
## <span id="SkaleToken"></span> `SkaleToken`
...
- [`constructor(address contractsAddress)`][SkaleToken-constructor-address-]
- [`mint(address to, uint256 amount)`][SkaleToken-mint-address-uint256-]
- [`burn(address from, uint256 amount)`][SkaleToken-burn-address-uint256-]
- [`transferWithData(address _to, uint256 _value, bytes _data)`][SkaleToken-transferWithData-address-uint256-bytes-]
...
- [`transfer(address _to, uint256 _value, bytes _data)`][StandardToken-transfer-address-uint256-bytes-]
- [`CAP()`][ISkaleToken-CAP--]
- [`Mint(address to, uint256 amount, uint32 time, uint256 gasSpend)`][SkaleToken-Mint-address-uint256-uint32-uint256-]
- [`Burn(address from, uint256 amount, uint32 time, uint256 gasSpend)`][SkaleToken-Burn-address-uint256-uint32-uint256-]
...
### <span id="SkaleToken-constructor-address-"></span> `constructor(address contractsAddress)` (public)



### <span id="SkaleToken-mint-address-uint256-"></span> `mint(address to, uint256 amount) → bool` (external)

mint - create some amount of token to specify address


### <span id="SkaleToken-burn-address-uint256-"></span> `burn(address from, uint256 amount) → bool` (external)

burn - burn some amount of token at specify address


### <span id="SkaleToken-transferWithData-address-uint256-bytes-"></span> `transferWithData(address _to, uint256 _value, bytes _data) → bool` (external)

Function that is called when a user or another contract wants to transfer funds.
It is alias for transfer function of StandardToken


### <span id="SkaleToken-Mint-address-uint256-uint32-uint256-"></span> `Mint(address to, uint256 amount, uint32 time, uint256 gasSpend)`



### <span id="SkaleToken-Burn-address-uint256-uint32-uint256-"></span> `Burn(address from, uint256 amount, uint32 time, uint256 gasSpend)`
