...
[SchainsData-constructor-string-address-]: #SchainsData-constructor-string-address-
...
[SchainsData-setSchainPartOfNode-bytes32-uint256-]: #SchainsData-setSchainPartOfNode-bytes32-uint256-
...
[ISchainsData-schainsAtSystem-uint256-]: #ISchainsData-schainsAtSystem-uint256-
[ISchainsData-numberOfSchains--]: #ISchainsData-numberOfSchains--
[ISchainsData-sumOfSchainsResources--]: #ISchainsData-sumOfSchainsResources--
[ISchainsData-schainsForNodes-uint256-uint256-]: #ISchainsData-schainsForNodes-uint256-uint256-
...
## <span id="SchainsData"></span> `SchainsData`
...
- [`constructor(string newExecutorName, address newContractsAddress)`][SchainsData-constructor-string-address-]
- [`initializeSchain(string name, address from, uint256 lifetime, uint256 deposit)`][SchainsData-initializeSchain-string-address-uint256-uint256-]
- [`setSchainIndex(bytes32 schainId, address from)`][SchainsData-setSchainIndex-bytes32-address-]
- [`addSchainForNode(uint256 nodeIndex, bytes32 schainId)`][SchainsData-addSchainForNode-uint256-bytes32-]
- [`setSchainPartOfNode(bytes32 schainId, uint256 partOfNode)`][SchainsData-setSchainPartOfNode-bytes32-uint256-]
- [`changeLifetime(bytes32 schainId, uint256 lifetime, uint256 deposit)`][SchainsData-changeLifetime-bytes32-uint256-uint256-]
- [`removeSchain(bytes32 schainId, address from)`][SchainsData-removeSchain-bytes32-address-]
- [`removeSchainForNode(uint256 nodeIndex, uint256 schainIndex)`][SchainsData-removeSchainForNode-uint256-uint256-]
- [`getSchains()`][SchainsData-getSchains--]
- [`getSchainsPartOfNode(bytes32 schainId)`][SchainsData-getSchainsPartOfNode-bytes32-]
- [`getSchainListSize(address from)`][SchainsData-getSchainListSize-address-]
- [`getSchainIdsByAddress(address from)`][SchainsData-getSchainIdsByAddress-address-]
- [`getSchainIdsForNode(uint256 nodeIndex)`][SchainsData-getSchainIdsForNode-uint256-]
- [`getLengthOfSchainsForNode(uint256 nodeIndex)`][SchainsData-getLengthOfSchainsForNode-uint256-]
- [`getSchainIdFromSchainName(string schainName)`][SchainsData-getSchainIdFromSchainName-string-]
- [`getSchainOwner(bytes32 schainId)`][SchainsData-getSchainOwner-bytes32-]
- [`isSchainNameAvailable(string name)`][SchainsData-isSchainNameAvailable-string-]
- [`isTimeExpired(bytes32 schainId)`][SchainsData-isTimeExpired-bytes32-]
- [`isOwnerAddress(address from, bytes32 schainId)`][SchainsData-isOwnerAddress-address-bytes32-]
- [`addGroup(bytes32 groupIndex, uint256 amountOfNodes, bytes32 data)`][GroupsData-addGroup-bytes32-uint256-bytes32-]
- [`setException(bytes32 groupIndex, uint256 nodeIndex)`][GroupsData-setException-bytes32-uint256-]
- [`setPublicKey(bytes32 groupIndex, uint256 publicKeyx1, uint256 publicKeyy1, uint256 publicKeyx2, uint256 publicKeyy2)`][GroupsData-setPublicKey-bytes32-uint256-uint256-uint256-uint256-]
- [`setNodeInGroup(bytes32 groupIndex, uint256 nodeIndex)`][GroupsData-setNodeInGroup-bytes32-uint256-]
- [`removeNodeFromGroup(uint256 indexOfNode, bytes32 groupIndex)`][GroupsData-removeNodeFromGroup-uint256-bytes32-]
- [`removeAllNodesInGroup(bytes32 groupIndex)`][GroupsData-removeAllNodesInGroup-bytes32-]
- [`setNodesInGroup(bytes32 groupIndex, uint256[] nodesInGroup)`][GroupsData-setNodesInGroup-bytes32-uint256---]
- [`setGroupFailedDKG(bytes32 groupIndex)`][GroupsData-setGroupFailedDKG-bytes32-]
- [`removeGroup(bytes32 groupIndex)`][GroupsData-removeGroup-bytes32-]
- [`removeExceptionNode(bytes32 groupIndex, uint256 nodeIndex)`][GroupsData-removeExceptionNode-bytes32-uint256-]
- [`isGroupActive(bytes32 groupIndex)`][GroupsData-isGroupActive-bytes32-]
- [`isExceptionNode(bytes32 groupIndex, uint256 nodeIndex)`][GroupsData-isExceptionNode-bytes32-uint256-]
- [`getGroupsPublicKey(bytes32 groupIndex)`][GroupsData-getGroupsPublicKey-bytes32-]
- [`getNodesInGroup(bytes32 groupIndex)`][GroupsData-getNodesInGroup-bytes32-]
- [`getGroupData(bytes32 groupIndex)`][GroupsData-getGroupData-bytes32-]
- [`getRecommendedNumberOfNodes(bytes32 groupIndex)`][GroupsData-getRecommendedNumberOfNodes-bytes32-]
- [`getNumberOfNodesInGroup(bytes32 groupIndex)`][GroupsData-getNumberOfNodesInGroup-bytes32-]
...
- [`schainsAtSystem(uint256 index)`][ISchainsData-schainsAtSystem-uint256-]
- [`numberOfSchains()`][ISchainsData-numberOfSchains--]
- [`sumOfSchainsResources()`][ISchainsData-sumOfSchainsResources--]
- [`schainsForNodes(uint256 nodeIndex, uint256 indexOfSchain)`][ISchainsData-schainsForNodes-uint256-uint256-]
### <span id="SchainsData-constructor-string-address-"></span> `constructor(string newExecutorName, address newContractsAddress)` (public)



### <span id="SchainsData-initializeSchain-string-address-uint256-uint256-"></span> `initializeSchain(string name, address from, uint256 lifetime, uint256 deposit)` (external)

initializeSchain - initializes Schain
function could be run only by executor


### <span id="SchainsData-setSchainIndex-bytes32-address-"></span> `setSchainIndex(bytes32 schainId, address from)` (external)

setSchainIndex - adds Schain's hash to owner
function could be run only by executor


### <span id="SchainsData-addSchainForNode-uint256-bytes32-"></span> `addSchainForNode(uint256 nodeIndex, bytes32 schainId)` (external)

addSchainForNode - adds Schain hash to Node
function could be run only by executor


### <span id="SchainsData-setSchainPartOfNode-bytes32-uint256-"></span> `setSchainPartOfNode(bytes32 schainId, uint256 partOfNode)` (external)

setSchainPartOfNode - sets how much Schain would be occupy of Node
function could be run onlye by executor


### <span id="SchainsData-changeLifetime-bytes32-uint256-uint256-"></span> `changeLifetime(bytes32 schainId, uint256 lifetime, uint256 deposit)` (external)

changeLifetime - changes Lifetime for Schain
function could be run only by executor


### <span id="SchainsData-removeSchain-bytes32-address-"></span> `removeSchain(bytes32 schainId, address from)` (external)

removeSchain - removes Schain from the system
function could be run only by executor


### <span id="SchainsData-removeSchainForNode-uint256-uint256-"></span> `removeSchainForNode(uint256 nodeIndex, uint256 schainIndex)` (external)

removesSchainForNode - clean given Node of Schain
function could be run only by executor


### <span id="SchainsData-getSchains--"></span> `getSchains() → bytes32[]` (external)

getSchains - gets all Schains at the system


### <span id="SchainsData-getSchainsPartOfNode-bytes32-"></span> `getSchainsPartOfNode(bytes32 schainId) → uint256` (external)

getSchainsPartOfNode - gets occupied space for given Schain


### <span id="SchainsData-getSchainListSize-address-"></span> `getSchainListSize(address from) → uint256` (external)

getSchainListSize - gets number of created Schains at the system by owner


### <span id="SchainsData-getSchainIdsByAddress-address-"></span> `getSchainIdsByAddress(address from) → bytes32[]` (external)

getSchainIdsByAddress - gets array of hashes by Schain names which owned by `from`


### <span id="SchainsData-getSchainIdsForNode-uint256-"></span> `getSchainIdsForNode(uint256 nodeIndex) → bytes32[]` (external)

getSchainIdsForNode - returns array of hashes by Schain names,
which given Node composed


### <span id="SchainsData-getLengthOfSchainsForNode-uint256-"></span> `getLengthOfSchainsForNode(uint256 nodeIndex) → uint256` (external)

getLengthOfSchainsForNode - returns number of Schains which contain given Node


### <span id="SchainsData-getSchainIdFromSchainName-string-"></span> `getSchainIdFromSchainName(string schainName) → bytes32` (external)

getSchainIdFromSchainName - returns hash of given name


### <span id="SchainsData-getSchainOwner-bytes32-"></span> `getSchainOwner(bytes32 schainId) → address` (external)



### <span id="SchainsData-isSchainNameAvailable-string-"></span> `isSchainNameAvailable(string name) → bool` (external)

isSchainNameAvailable - checks is given name available
Need to delete - copy of web3.utils.soliditySha3


### <span id="SchainsData-isTimeExpired-bytes32-"></span> `isTimeExpired(bytes32 schainId) → bool` (external)

isTimeExpired - checks is Schain lifetime expired


### <span id="SchainsData-isOwnerAddress-address-bytes32-"></span> `isOwnerAddress(address from, bytes32 schainId) → bool` (external)
