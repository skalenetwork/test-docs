...
[NodesFunctionality-constructor-address-]: #NodesFunctionality-constructor-address-
[NodesFunctionality-createNode-address-uint256-bytes-]: #NodesFunctionality-createNode-address-uint256-bytes-
[NodesFunctionality-removeNode-address-uint256-]: #NodesFunctionality-removeNode-address-uint256-
[NodesFunctionality-removeNodeByRoot-uint256-]: #NodesFunctionality-removeNodeByRoot-uint256-
[NodesFunctionality-initWithdrawDeposit-address-uint256-]: #NodesFunctionality-initWithdrawDeposit-address-uint256-
[NodesFunctionality-completeWithdrawDeposit-address-uint256-]: #NodesFunctionality-completeWithdrawDeposit-address-uint256-
[NodesFunctionality-setNodeType-address-address-uint256-]: #NodesFunctionality-setNodeType-address-address-uint256-
[Ownable-constructor--]: #Ownable-constructor--
[Ownable-transferOwnership-address-]: #Ownable-transferOwnership-address-
[NodesFunctionality-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-uint32-uint256-]: #NodesFunctionality-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-uint32-uint256-
[NodesFunctionality-WithdrawDepositFromNodeComplete-uint256-address-uint256-uint32-uint256-]: #NodesFunctionality-WithdrawDepositFromNodeComplete-uint256-address-uint256-uint32-uint256-
[NodesFunctionality-WithdrawDepositFromNodeInit-uint256-address-uint32-uint32-uint256-]: #NodesFunctionality-WithdrawDepositFromNodeInit-uint256-address-uint32-uint32-uint256-
...
## <span id="NodesFunctionality"></span> `NodesFunctionality`
...
- [`constructor(address newContractsAddress)`][NodesFunctionality-constructor-address-]
- [`createNode(address from, uint256 value, bytes data)`][NodesFunctionality-createNode-address-uint256-bytes-]
- [`removeNode(address from, uint256 nodeIndex)`][NodesFunctionality-removeNode-address-uint256-]
- [`removeNodeByRoot(uint256 nodeIndex)`][NodesFunctionality-removeNodeByRoot-uint256-]
- [`initWithdrawDeposit(address from, uint256 nodeIndex)`][NodesFunctionality-initWithdrawDeposit-address-uint256-]
- [`completeWithdrawDeposit(address from, uint256 nodeIndex)`][NodesFunctionality-completeWithdrawDeposit-address-uint256-]
- [`setNodeType(address nodesDataAddress, address constantsAddress, uint256 nodeIndex)`][NodesFunctionality-setNodeType-address-address-uint256-]
- [`constructor()`][Ownable-constructor--]
- [`transferOwnership(address newOwner)`][Ownable-transferOwnership-address-]
- [`NodeCreated(uint256 nodeIndex, address owner, string name, bytes4 ip, bytes4 publicIP, uint16 port, uint16 nonce, uint32 time, uint256 gasSpend)`][NodesFunctionality-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-uint32-uint256-]
- [`WithdrawDepositFromNodeComplete(uint256 nodeIndex, address owner, uint256 deposit, uint32 time, uint256 gasSpend)`][NodesFunctionality-WithdrawDepositFromNodeComplete-uint256-address-uint256-uint32-uint256-]
- [`WithdrawDepositFromNodeInit(uint256 nodeIndex, address owner, uint32 startLeavingPeriod, uint32 time, uint256 gasSpend)`][NodesFunctionality-WithdrawDepositFromNodeInit-uint256-address-uint32-uint32-uint256-]
### <span id="NodesFunctionality-constructor-address-"></span> `constructor(address newContractsAddress)` (public)

constructor in Permissions approach


### <span id="NodesFunctionality-createNode-address-uint256-bytes-"></span> `createNode(address from, uint256 value, bytes data) → uint256 nodeIndex` (external)

createNode - creates new Node and add it to the NodesData contract
function could be only run by SkaleManager


### <span id="NodesFunctionality-removeNode-address-uint256-"></span> `removeNode(address from, uint256 nodeIndex)` (external)

removeNode - delete Node
function could be only run by SkaleManager


### <span id="NodesFunctionality-removeNodeByRoot-uint256-"></span> `removeNodeByRoot(uint256 nodeIndex)` (external)



### <span id="NodesFunctionality-initWithdrawDeposit-address-uint256-"></span> `initWithdrawDeposit(address from, uint256 nodeIndex) → bool` (external)

initWithdrawdeposit - initiate a procedure of quiting the system
function could be only run by SkaleManager


### <span id="NodesFunctionality-completeWithdrawDeposit-address-uint256-"></span> `completeWithdrawDeposit(address from, uint256 nodeIndex) → uint256` (external)

completeWithdrawDeposit - finish a procedure of quiting the system
function could be run only by SkaleMManager


### <span id="NodesFunctionality-setNodeType-address-address-uint256-"></span> `setNodeType(address nodesDataAddress, address constantsAddress, uint256 nodeIndex)` (internal)

setNodeType - sets Node to Fractional Nodes or to Full Nodes


### <span id="NodesFunctionality-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-uint32-uint256-"></span> `NodeCreated(uint256 nodeIndex, address owner, string name, bytes4 ip, bytes4 publicIP, uint16 port, uint16 nonce, uint32 time, uint256 gasSpend)`



### <span id="NodesFunctionality-WithdrawDepositFromNodeComplete-uint256-address-uint256-uint32-uint256-"></span> `WithdrawDepositFromNodeComplete(uint256 nodeIndex, address owner, uint256 deposit, uint32 time, uint256 gasSpend)`



### <span id="NodesFunctionality-WithdrawDepositFromNodeInit-uint256-address-uint32-uint32-uint256-"></span> `WithdrawDepositFromNodeInit(uint256 nodeIndex, address owner, uint32 startLeavingPeriod, uint32 time, uint256 gasSpend)`
