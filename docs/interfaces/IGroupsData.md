...
## <span id="IGroupsData"></span> `IGroupsData`



- [`addGroup(bytes32 groupIndex, uint256 amountOfNodes, bytes32 data)`][IGroupsData-addGroup-bytes32-uint256-bytes32-]
- [`removeAllNodesInGroup(bytes32 groupIndex)`][IGroupsData-removeAllNodesInGroup-bytes32-]
- [`setNodeInGroup(bytes32 groupIndex, uint256 nodeIndex)`][IGroupsData-setNodeInGroup-bytes32-uint256-]
- [`setNodesInGroup(bytes32 groupIndex, uint256[] nodesInGroup)`][IGroupsData-setNodesInGroup-bytes32-uint256---]
- [`removeExceptionNode(bytes32 groupIndex, uint256 nodeIndex)`][IGroupsData-removeExceptionNode-bytes32-uint256-]
- [`removeGroup(bytes32 groupIndex)`][IGroupsData-removeGroup-bytes32-]
- [`setException(bytes32 groupIndex, uint256 nodeIndex)`][IGroupsData-setException-bytes32-uint256-]
- [`isGroupActive(bytes32 groupIndex)`][IGroupsData-isGroupActive-bytes32-]
- [`isExceptionNode(bytes32 groupIndex, uint256 nodeIndex)`][IGroupsData-isExceptionNode-bytes32-uint256-]
- [`getGroupsPublicKey(bytes32 groupIndex)`][IGroupsData-getGroupsPublicKey-bytes32-]
- [`getNodesInGroup(bytes32 schainId)`][IGroupsData-getNodesInGroup-bytes32-]
- [`getGroupData(bytes32 groupIndex)`][IGroupsData-getGroupData-bytes32-]
- [`getRecommendedNumberOfNodes(bytes32 groupIndex)`][IGroupsData-getRecommendedNumberOfNodes-bytes32-]
- [`getNumberOfNodesInGroup(bytes32 groupIndex)`][IGroupsData-getNumberOfNodesInGroup-bytes32-]
- [`removeNodeFromGroup(uint256 nodeIndex, bytes32 groupIndex)`][IGroupsData-removeNodeFromGroup-uint256-bytes32-]
- [`setPublicKey(bytes32 groupIndex, uint256 pubKeyx1, uint256 pubKeyy1, uint256 pubKeyx2, uint256 pubKeyy2)`][IGroupsData-setPublicKey-bytes32-uint256-uint256-uint256-uint256-]
- [`setGroupFailedDKG(bytes32 groupIndex)`][IGroupsData-setGroupFailedDKG-bytes32-]
### <span id="IGroupsData-addGroup-bytes32-uint256-bytes32-"></span> `addGroup(bytes32 groupIndex, uint256 amountOfNodes, bytes32 data)` (external)



### <span id="IGroupsData-removeAllNodesInGroup-bytes32-"></span> `removeAllNodesInGroup(bytes32 groupIndex)` (external)



### <span id="IGroupsData-setNodeInGroup-bytes32-uint256-"></span> `setNodeInGroup(bytes32 groupIndex, uint256 nodeIndex)` (external)



### <span id="IGroupsData-setNodesInGroup-bytes32-uint256---"></span> `setNodesInGroup(bytes32 groupIndex, uint256[] nodesInGroup)` (external)



### <span id="IGroupsData-removeExceptionNode-bytes32-uint256-"></span> `removeExceptionNode(bytes32 groupIndex, uint256 nodeIndex)` (external)



### <span id="IGroupsData-removeGroup-bytes32-"></span> `removeGroup(bytes32 groupIndex)` (external)



### <span id="IGroupsData-setException-bytes32-uint256-"></span> `setException(bytes32 groupIndex, uint256 nodeIndex)` (external)



### <span id="IGroupsData-isGroupActive-bytes32-"></span> `isGroupActive(bytes32 groupIndex) → bool` (external)



### <span id="IGroupsData-isExceptionNode-bytes32-uint256-"></span> `isExceptionNode(bytes32 groupIndex, uint256 nodeIndex) → bool` (external)



### <span id="IGroupsData-getGroupsPublicKey-bytes32-"></span> `getGroupsPublicKey(bytes32 groupIndex) → uint256, uint256, uint256, uint256` (external)



### <span id="IGroupsData-getNodesInGroup-bytes32-"></span> `getNodesInGroup(bytes32 schainId) → uint256[]` (external)



### <span id="IGroupsData-getGroupData-bytes32-"></span> `getGroupData(bytes32 groupIndex) → bytes32` (external)



### <span id="IGroupsData-getRecommendedNumberOfNodes-bytes32-"></span> `getRecommendedNumberOfNodes(bytes32 groupIndex) → uint256` (external)



### <span id="IGroupsData-getNumberOfNodesInGroup-bytes32-"></span> `getNumberOfNodesInGroup(bytes32 groupIndex) → uint256` (external)



### <span id="IGroupsData-removeNodeFromGroup-uint256-bytes32-"></span> `removeNodeFromGroup(uint256 nodeIndex, bytes32 groupIndex)` (external)



### <span id="IGroupsData-setPublicKey-bytes32-uint256-uint256-uint256-uint256-"></span> `setPublicKey(bytes32 groupIndex, uint256 pubKeyx1, uint256 pubKeyy1, uint256 pubKeyx2, uint256 pubKeyy2)` (external)



### <span id="IGroupsData-setGroupFailedDKG-bytes32-"></span> `setGroupFailedDKG(bytes32 groupIndex)` (external)
