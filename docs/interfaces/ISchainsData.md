...
[ISchainsData-addSchainForNode-uint256-bytes32-]: #ISchainsData-addSchainForNode-uint256-bytes32-
[ISchainsData-setSchainPartOfNode-bytes32-uint256-]: #ISchainsData-setSchainPartOfNode-bytes32-uint256-
[ISchainsData-getLengthOfSchainsForNode-uint256-]: #ISchainsData-getLengthOfSchainsForNode-uint256-
[ISchainsData-schainsForNodes-uint256-uint256-]: #ISchainsData-schainsForNodes-uint256-uint256-
[ISchainsData-getSchainOwner-bytes32-]: #ISchainsData-getSchainOwner-bytes32-
[ISchainsData-initializeSchain-string-address-uint256-uint256-]: #ISchainsData-initializeSchain-string-address-uint256-uint256-
[ISchainsData-setSchainIndex-bytes32-address-]: #ISchainsData-setSchainIndex-bytes32-address-
[ISchainsData-removeSchain-bytes32-address-]: #ISchainsData-removeSchain-bytes32-address-
[ISchainsData-removeSchainForNode-uint256-uint256-]: #ISchainsData-removeSchainForNode-uint256-uint256-
[ISchainsData-isTimeExpired-bytes32-]: #ISchainsData-isTimeExpired-bytes32-
[ISchainsData-isOwnerAddress-address-bytes32-]: #ISchainsData-isOwnerAddress-address-bytes32-
[ISchainsData-isSchainNameAvailable-string-]: #ISchainsData-isSchainNameAvailable-string-
[ISchainsData-getSchainsPartOfNode-bytes32-]: #ISchainsData-getSchainsPartOfNode-bytes32-
[ISchainsData-getSchainIdsForNode-uint256-]: #ISchainsData-getSchainIdsForNode-uint256-
...
## <span id="ISchainsData"></span> `ISchainsData`
...
- [`addSchainForNode(uint256 nodeIndex, bytes32 schainId)`][ISchainsData-addSchainForNode-uint256-bytes32-]
- [`setSchainPartOfNode(bytes32 schainId, uint256 partOfNode)`][ISchainsData-setSchainPartOfNode-bytes32-uint256-]
- [`getLengthOfSchainsForNode(uint256 nodeIndex)`][ISchainsData-getLengthOfSchainsForNode-uint256-]
- [`schainsForNodes(uint256 nodeIndex, uint256 indexOfSchain)`][ISchainsData-schainsForNodes-uint256-uint256-]
- [`getSchainOwner(bytes32 schainId)`][ISchainsData-getSchainOwner-bytes32-]
- [`initializeSchain(string name, address from, uint256 lifetime, uint256 deposit)`][ISchainsData-initializeSchain-string-address-uint256-uint256-]
- [`setSchainIndex(bytes32 schainId, address from)`][ISchainsData-setSchainIndex-bytes32-address-]
- [`removeSchain(bytes32 schainId, address from)`][ISchainsData-removeSchain-bytes32-address-]
- [`removeSchainForNode(uint256 nodeIndex, uint256 schainIndex)`][ISchainsData-removeSchainForNode-uint256-uint256-]
- [`isTimeExpired(bytes32 schainId)`][ISchainsData-isTimeExpired-bytes32-]
- [`isOwnerAddress(address from, bytes32 schainId)`][ISchainsData-isOwnerAddress-address-bytes32-]
- [`isSchainNameAvailable(string name)`][ISchainsData-isSchainNameAvailable-string-]
- [`getSchainsPartOfNode(bytes32 schainId)`][ISchainsData-getSchainsPartOfNode-bytes32-]
- [`getSchainIdsForNode(uint256 nodeIndex)`][ISchainsData-getSchainIdsForNode-uint256-]
### <span id="ISchainsData-schainsAtSystem-uint256-"></span> `schainsAtSystem(uint256 index) → bytes32` (external)



### <span id="ISchainsData-numberOfSchains--"></span> `numberOfSchains() → uint64` (external)



### <span id="ISchainsData-sumOfSchainsResources--"></span> `sumOfSchainsResources() → uint256` (external)



### <span id="ISchainsData-addSchainForNode-uint256-bytes32-"></span> `addSchainForNode(uint256 nodeIndex, bytes32 schainId)` (external)



### <span id="ISchainsData-setSchainPartOfNode-bytes32-uint256-"></span> `setSchainPartOfNode(bytes32 schainId, uint256 partOfNode)` (external)



### <span id="ISchainsData-getLengthOfSchainsForNode-uint256-"></span> `getLengthOfSchainsForNode(uint256 nodeIndex) → uint256` (external)



### <span id="ISchainsData-schainsForNodes-uint256-uint256-"></span> `schainsForNodes(uint256 nodeIndex, uint256 indexOfSchain) → bytes32` (external)



### <span id="ISchainsData-getSchainOwner-bytes32-"></span> `getSchainOwner(bytes32 schainId) → address` (external)



### <span id="ISchainsData-initializeSchain-string-address-uint256-uint256-"></span> `initializeSchain(string name, address from, uint256 lifetime, uint256 deposit)` (external)



### <span id="ISchainsData-setSchainIndex-bytes32-address-"></span> `setSchainIndex(bytes32 schainId, address from)` (external)



### <span id="ISchainsData-removeSchain-bytes32-address-"></span> `removeSchain(bytes32 schainId, address from)` (external)



### <span id="ISchainsData-removeSchainForNode-uint256-uint256-"></span> `removeSchainForNode(uint256 nodeIndex, uint256 schainIndex)` (external)



### <span id="ISchainsData-isTimeExpired-bytes32-"></span> `isTimeExpired(bytes32 schainId) → bool` (external)



### <span id="ISchainsData-isOwnerAddress-address-bytes32-"></span> `isOwnerAddress(address from, bytes32 schainId) → bool` (external)



### <span id="ISchainsData-isSchainNameAvailable-string-"></span> `isSchainNameAvailable(string name) → bool` (external)



### <span id="ISchainsData-getSchainsPartOfNode-bytes32-"></span> `getSchainsPartOfNode(bytes32 schainId) → uint256` (external)



### <span id="ISchainsData-getSchainIdsForNode-uint256-"></span> `getSchainIdsForNode(uint256 nodeIndex) → bytes32[]` (external)
