...
[ISchainsFunctionality]: #ISchainsFunctionality
[ISchainsFunctionality-addSchain-address-uint256-bytes-]: #ISchainsFunctionality-addSchain-address-uint256-bytes-
[ISchainsFunctionality-deleteSchain-address-string-]: #ISchainsFunctionality-deleteSchain-address-string-
[ISchainsFunctionality-deleteSchainByRoot-string-]: #ISchainsFunctionality-deleteSchainByRoot-string-
...
## <span id="ISchainsFunctionality"></span> `ISchainsFunctionality`



- [`addSchain(address from, uint256 value, bytes data)`][ISchainsFunctionality-addSchain-address-uint256-bytes-]
- [`deleteSchain(address from, string name)`][ISchainsFunctionality-deleteSchain-address-string-]
- [`deleteSchainByRoot(string name)`][ISchainsFunctionality-deleteSchainByRoot-string-]
### <span id="ISchainsFunctionality-addSchain-address-uint256-bytes-"></span> `addSchain(address from, uint256 value, bytes data)` (external)



### <span id="ISchainsFunctionality-deleteSchain-address-string-"></span> `deleteSchain(address from, string name)` (external)



### <span id="ISchainsFunctionality-deleteSchainByRoot-string-"></span> `deleteSchainByRoot(string name)` (external)
