...
[IValidatorsFunctionality]: #IValidatorsFunctionality
[IValidatorsFunctionality-addValidator-uint256-]: #IValidatorsFunctionality-addValidator-uint256-
[IValidatorsFunctionality-upgradeValidator-uint256-]: #IValidatorsFunctionality-upgradeValidator-uint256-
[IValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-]: #IValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-
[IValidatorsFunctionality-calculateMetrics-uint256-]: #IValidatorsFunctionality-calculateMetrics-uint256-
[IValidatorsFunctionality-deleteValidatorByRoot-uint256-]: #IValidatorsFunctionality-deleteValidatorByRoot-uint256-
## <span id="IValidatorsFunctionality"></span> `IValidatorsFunctionality`



- [`addValidator(uint256 nodeIndex)`][IValidatorsFunctionality-addValidator-uint256-]
- [`upgradeValidator(uint256 nodeIndex)`][IValidatorsFunctionality-upgradeValidator-uint256-]
- [`sendVerdict(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency)`][IValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-]
- [`calculateMetrics(uint256 nodeIndex)`][IValidatorsFunctionality-calculateMetrics-uint256-]
- [`deleteValidatorByRoot(uint256 nodeIndex)`][IValidatorsFunctionality-deleteValidatorByRoot-uint256-]
### <span id="IValidatorsFunctionality-addValidator-uint256-"></span> `addValidator(uint256 nodeIndex)` (external)



### <span id="IValidatorsFunctionality-upgradeValidator-uint256-"></span> `upgradeValidator(uint256 nodeIndex)` (external)



### <span id="IValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-"></span> `sendVerdict(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency)` (external)



### <span id="IValidatorsFunctionality-calculateMetrics-uint256-"></span> `calculateMetrics(uint256 nodeIndex) → uint32, uint32` (external)



### <span id="IValidatorsFunctionality-deleteValidatorByRoot-uint256-"></span> `deleteValidatorByRoot(uint256 nodeIndex)` (external)
