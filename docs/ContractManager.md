...
[ContractManager-setContractsAddress-string-address-]: #ContractManager-setContractsAddress-string-address-
[Ownable-constructor--]: #Ownable-constructor--
[Ownable-transferOwnership-address-]: #Ownable-transferOwnership-address-
[ContractManager-ContractUpgraded-string-address-]: #ContractManager-ContractUpgraded-string-address-
...
## <span id="ContractManager"></span> `ContractManager`



- [`onlyOwner()`][Ownable-onlyOwner--]
- [`setContractsAddress(string contractsName, address newContractsAddress)`][ContractManager-setContractsAddress-string-address-]
- [`constructor()`][Ownable-constructor--]
- [`transferOwnership(address newOwner)`][Ownable-transferOwnership-address-]
- [`ContractUpgraded(string contractsName, address contractsAddress)`][ContractManager-ContractUpgraded-string-address-]
### <span id="ContractManager-setContractsAddress-string-address-"></span> `setContractsAddress(string contractsName, address newContractsAddress)` (external)



### <span id="ContractManager-ContractUpgraded-string-address-"></span> `ContractUpgraded(string contractsName, address contractsAddress)`
