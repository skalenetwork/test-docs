...
[SchainsFunctionalityInternal-constructor-string-string-address-]: #SchainsFunctionalityInternal-constructor-string-string-address-
[SchainsFunctionalityInternal-createGroupForSchain-string-bytes32-uint256-uint256-]: #SchainsFunctionalityInternal-createGroupForSchain-string-bytes32-uint256-uint256-
...
[SchainsFunctionalityInternal-replaceNode-uint256-bytes32-]: #SchainsFunctionalityInternal-replaceNode-uint256-bytes32-
...
[SchainsFunctionalityInternal-generateGroup-bytes32-]: #SchainsFunctionalityInternal-generateGroup-bytes32-
[SchainsFunctionalityInternal-comparator-uint256-uint256-uint256-uint256-]: #SchainsFunctionalityInternal-comparator-uint256-uint256-uint256-uint256-
[SchainsFunctionalityInternal-returnValidNodeIndex-uint256-uint256-]: #SchainsFunctionalityInternal-returnValidNodeIndex-uint256-uint256-
[SchainsFunctionalityInternal-removeSpace-uint256-uint256-]: #SchainsFunctionalityInternal-removeSpace-uint256-uint256-
[SchainsFunctionalityInternal-setNumberOfNodesInGroup-bytes32-uint256-address-]: #SchainsFunctionalityInternal-setNumberOfNodesInGroup-bytes32-uint256-address-
...
## <span id="SchainsFunctionalityInternal"></span> `SchainsFunctionalityInternal`
...
- [`constructor(string newExecutorName, string newDataName, address newContractsAddress)`][SchainsFunctionalityInternal-constructor-string-string-address-]
- [`createGroupForSchain(string schainName, bytes32 schainId, uint256 numberOfNodes, uint256 partOfNode)`][SchainsFunctionalityInternal-createGroupForSchain-string-bytes32-uint256-uint256-]
- [`getNodesDataFromTypeOfSchain(uint256 typeOfSchain)`][SchainsFunctionalityInternal-getNodesDataFromTypeOfSchain-uint256-]
- [`replaceNode(uint256 nodeIndex, bytes32 groupHash)`][SchainsFunctionalityInternal-replaceNode-uint256-bytes32-]
- [`findSchainAtSchainsForNode(uint256 nodeIndex, bytes32 schainId)`][SchainsFunctionalityInternal-findSchainAtSchainsForNode-uint256-bytes32-]
- [`removeNodeFromSchain(uint256 nodeIndex, bytes32 groupHash)`][SchainsFunctionalityInternal-removeNodeFromSchain-uint256-bytes32-]
- [`selectNodeToGroup(bytes32 schainId)`][SchainsFunctionalityInternal-selectNodeToGroup-bytes32-]
- [`generateGroup(bytes32 groupIndex)`][SchainsFunctionalityInternal-generateGroup-bytes32-]
- [`comparator(uint256 indexOfNode, uint256 nodeIndex, uint256 partOfNode, uint256 space)`][SchainsFunctionalityInternal-comparator-uint256-uint256-uint256-uint256-]
- [`returnValidNodeIndex(uint256 partOfNode, uint256 indexOfNode)`][SchainsFunctionalityInternal-returnValidNodeIndex-uint256-uint256-]
- [`removeSpace(uint256 nodeIndex, uint256 space)`][SchainsFunctionalityInternal-removeSpace-uint256-uint256-]
- [`setNumberOfNodesInGroup(bytes32 groupIndex, uint256 partOfNode, address dataAddress)`][SchainsFunctionalityInternal-setNumberOfNodesInGroup-bytes32-uint256-address-]
...
- [`SchainNodes(string name, bytes32 groupIndex, uint256[] nodesInGroup, uint32 time, uint256 gasSpend)`][SchainsFunctionalityInternal-SchainNodes-string-bytes32-uint256---uint32-uint256-]
...
### <span id="SchainsFunctionalityInternal-constructor-string-string-address-"></span> `constructor(string newExecutorName, string newDataName, address newContractsAddress)` (public)



### <span id="SchainsFunctionalityInternal-createGroupForSchain-string-bytes32-uint256-uint256-"></span> `createGroupForSchain(string schainName, bytes32 schainId, uint256 numberOfNodes, uint256 partOfNode)` (external)

createGroupForSchain - creates Group for Schain


### <span id="SchainsFunctionalityInternal-getNodesDataFromTypeOfSchain-uint256-"></span> `getNodesDataFromTypeOfSchain(uint256 typeOfSchain) → uint256 numberOfNodes, uint256 partOfNode` (external)

getNodesDataFromTypeOfSchain - returns number if Nodes
and part of Node which needed to this Schain


### <span id="SchainsFunctionalityInternal-replaceNode-uint256-bytes32-"></span> `replaceNode(uint256 nodeIndex, bytes32 groupHash) → bytes32 schainId, uint256 newNodeIndex` (external)



### <span id="SchainsFunctionalityInternal-findSchainAtSchainsForNode-uint256-bytes32-"></span> `findSchainAtSchainsForNode(uint256 nodeIndex, bytes32 schainId) → uint256` (public)

findSchainAtSchainsForNode - finds index of Schain at schainsForNode array


### <span id="SchainsFunctionalityInternal-removeNodeFromSchain-uint256-bytes32-"></span> `removeNodeFromSchain(uint256 nodeIndex, bytes32 groupHash)` (public)



### <span id="SchainsFunctionalityInternal-selectNodeToGroup-bytes32-"></span> `selectNodeToGroup(bytes32 schainId) → bytes32, uint256` (internal)

selectNodeToGroup - pseudo-randomly select new Node for Schain


### <span id="SchainsFunctionalityInternal-generateGroup-bytes32-"></span> `generateGroup(bytes32 groupIndex) → uint256[] nodesInGroup` (internal)

generateGroup - generates Group for Schain


### <span id="SchainsFunctionalityInternal-comparator-uint256-uint256-uint256-uint256-"></span> `comparator(uint256 indexOfNode, uint256 nodeIndex, uint256 partOfNode, uint256 space) → bool` (internal)

comparator - checks that Node is fitted to be a part of Schain


### <span id="SchainsFunctionalityInternal-returnValidNodeIndex-uint256-uint256-"></span> `returnValidNodeIndex(uint256 partOfNode, uint256 indexOfNode) → uint256 nodeIndex` (internal)

returnValidNodeIndex - returns nodeIndex from indexOfNode at Full Nodes
and Fractional Nodes array


### <span id="SchainsFunctionalityInternal-removeSpace-uint256-uint256-"></span> `removeSpace(uint256 nodeIndex, uint256 space) → bool` (internal)

removeSpace - occupy space of given Node


### <span id="SchainsFunctionalityInternal-setNumberOfNodesInGroup-bytes32-uint256-address-"></span> `setNumberOfNodesInGroup(bytes32 groupIndex, uint256 partOfNode, address dataAddress) → uint256 numberOfNodes, uint256 space` (internal)

setNumberOfNodesInGroup - checks is Nodes enough to create Schain
and returns number of Nodes in group
and how much space would be occupied on its, based on given type of Schain


### <span id="SchainsFunctionalityInternal-SchainNodes-string-bytes32-uint256---uint32-uint256-"></span> `SchainNodes(string name, bytes32 groupIndex, uint256[] nodesInGroup, uint32 time, uint256 gasSpend)`
