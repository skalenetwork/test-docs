...
[ISchainsFunctionalityInternal]: #ISchainsFunctionalityInternal
[ISchainsFunctionalityInternal-getNodesDataFromTypeOfSchain-uint256-]: #ISchainsFunctionalityInternal-getNodesDataFromTypeOfSchain-uint256-
[ISchainsFunctionalityInternal-createGroupForSchain-string-bytes32-uint256-uint256-]: #ISchainsFunctionalityInternal-createGroupForSchain-string-bytes32-uint256-uint256-
[ISchainsFunctionalityInternal-findSchainAtSchainsForNode-uint256-bytes32-]: #ISchainsFunctionalityInternal-findSchainAtSchainsForNode-uint256-bytes32-
[ISchainsFunctionalityInternal-deleteGroup-bytes32-]: #ISchainsFunctionalityInternal-deleteGroup-bytes32-
[ISchainsFunctionalityInternal-replaceNode-uint256-bytes32-]: #ISchainsFunctionalityInternal-replaceNode-uint256-bytes32-
[ISchainsFunctionalityInternal-removeNodeFromSchain-uint256-bytes32-]: #ISchainsFunctionalityInternal-removeNodeFromSchain-uint256-bytes32-
...
[SchainsFunctionality-constructor-string-string-address-]: #SchainsFunctionality-constructor-string-string-address-
...
[SchainsFunctionality-initializeSchainInSchainsData-string-address-uint256-uint256-]: #SchainsFunctionality-initializeSchainInSchainsData-string-address-uint256-uint256-
[SchainsFunctionality-fallbackSchainParametersDataConverter-bytes-]: #SchainsFunctionality-fallbackSchainParametersDataConverter-bytes-
[SchainsFunctionality-addSpace-uint256-uint256-]: #SchainsFunctionality-addSpace-uint256-uint256-
...
[SchainsFunctionality-NodeRotated-bytes32-uint256-]: #SchainsFunctionality-NodeRotated-bytes32-uint256-
...
## <span id="SchainsFunctionality"></span> `SchainsFunctionality`
...
- [`constructor(string newExecutorName, string newDataName, address newContractsAddress)`][SchainsFunctionality-constructor-string-string-address-]
- [`addSchain(address from, uint256 deposit, bytes data)`][SchainsFunctionality-addSchain-address-uint256-bytes-]
- [`deleteSchain(address from, string name)`][SchainsFunctionality-deleteSchain-address-string-]
- [`deleteSchainByRoot(string name)`][SchainsFunctionality-deleteSchainByRoot-string-]
- [`rotateNode(uint256 nodeIndex, bytes32 schainId)`][SchainsFunctionality-rotateNode-uint256-bytes32-]
- [`getSchainPrice(uint256 typeOfSchain, uint256 lifetime)`][SchainsFunctionality-getSchainPrice-uint256-uint256-]
- [`initializeSchainInSchainsData(string name, address from, uint256 deposit, uint256 lifetime)`][SchainsFunctionality-initializeSchainInSchainsData-string-address-uint256-uint256-]
- [`fallbackSchainParametersDataConverter(bytes data)`][SchainsFunctionality-fallbackSchainParametersDataConverter-bytes-]
- [`addSpace(uint256 nodeIndex, uint256 partOfNode)`][SchainsFunctionality-addSpace-uint256-uint256-]
...
- [`SchainCreated(string name, address owner, uint256 partOfNode, uint256 lifetime, uint256 numberOfNodes, uint256 deposit, uint16 nonce, bytes32 groupIndex, uint32 time, uint256 gasSpend)`][SchainsFunctionality-SchainCreated-string-address-uint256-uint256-uint256-uint256-uint16-bytes32-uint32-uint256-]
- [`SchainDeleted(address owner, string name, bytes32 schainId)`][SchainsFunctionality-SchainDeleted-address-string-bytes32-]
- [`NodeRotated(bytes32 groupIndex, uint256 newNode)`][SchainsFunctionality-NodeRotated-bytes32-uint256-]
### <span id="SchainsFunctionality-constructor-string-string-address-"></span> `constructor(string newExecutorName, string newDataName, address newContractsAddress)` (public)



### <span id="SchainsFunctionality-addSchain-address-uint256-bytes-"></span> `addSchain(address from, uint256 deposit, bytes data)` (external)

addSchain - create Schain in the system
function could be run only by executor


### <span id="SchainsFunctionality-deleteSchain-address-string-"></span> `deleteSchain(address from, string name)` (external)

deleteSchain - removes Schain from the system
function could be run only by executor


### <span id="SchainsFunctionality-deleteSchainByRoot-string-"></span> `deleteSchainByRoot(string name)` (external)



### <span id="SchainsFunctionality-rotateNode-uint256-bytes32-"></span> `rotateNode(uint256 nodeIndex, bytes32 schainId)` (external)



### <span id="SchainsFunctionality-getSchainPrice-uint256-uint256-"></span> `getSchainPrice(uint256 typeOfSchain, uint256 lifetime) → uint256` (public)

getSchainPrice - returns current price for given Schain


### <span id="SchainsFunctionality-initializeSchainInSchainsData-string-address-uint256-uint256-"></span> `initializeSchainInSchainsData(string name, address from, uint256 deposit, uint256 lifetime)` (internal)



### <span id="SchainsFunctionality-fallbackSchainParametersDataConverter-bytes-"></span> `fallbackSchainParametersDataConverter(bytes data) → struct SchainsFunctionality.SchainParameters schainParameters` (internal)

fallbackSchainParameterDataConverter - converts data from bytes to normal parameters


### <span id="SchainsFunctionality-addSpace-uint256-uint256-"></span> `addSpace(uint256 nodeIndex, uint256 partOfNode)` (internal)

addSpace - return occupied space to Node


### <span id="SchainsFunctionality-SchainCreated-string-address-uint256-uint256-uint256-uint256-uint16-bytes32-uint32-uint256-"></span> `SchainCreated(string name, address owner, uint256 partOfNode, uint256 lifetime, uint256 numberOfNodes, uint256 deposit, uint16 nonce, bytes32 groupIndex, uint32 time, uint256 gasSpend)`



### <span id="SchainsFunctionality-SchainDeleted-address-string-bytes32-"></span> `SchainDeleted(address owner, string name, bytes32 schainId)`



### <span id="SchainsFunctionality-NodeRotated-bytes32-uint256-"></span> `NodeRotated(bytes32 groupIndex, uint256 newNode)`
