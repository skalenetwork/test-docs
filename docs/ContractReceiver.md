...
[ContractReceiver-tokenFallback-address-uint256-bytes-]: #ContractReceiver-tokenFallback-address-uint256-bytes-
...
## <span id="ContractReceiver"></span> `ContractReceiver`



- [`tokenFallback(address _from, uint256 _value, bytes _data)`][ContractReceiver-tokenFallback-address-uint256-bytes-]
### <span id="ContractReceiver-tokenFallback-address-uint256-bytes-"></span> `tokenFallback(address _from, uint256 _value, bytes _data)` (external)
