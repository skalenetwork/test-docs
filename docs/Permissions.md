...
### <span id="Permissions-allow-string-"></span> `allow(string contractName)`

allow - throws if called by any account and contract other than the owner
or `contractName` contract


### <span id="Permissions-allowMultiple-string-string-"></span> `allowMultiple(string contractNameFirst, string contractNameSecond)`



### <span id="Permissions-constructor-address-"></span> `constructor(address newContractsAddress)` (public)
