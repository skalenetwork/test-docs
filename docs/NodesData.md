[ConstantsHolder]: ConstantsHolder.md#ConstantsHolder
...
[NodesData-constructor-uint256-address-]: #NodesData-constructor-uint256-address-
[NodesData-getNodesWithFreeSpace-uint256-uint256-]: #NodesData-getNodesWithFreeSpace-uint256-uint256-
[NodesData-addNode-address-string-bytes4-bytes4-uint16-bytes-]: #NodesData-addNode-address-string-bytes4-bytes4-uint16-bytes-
[NodesData-addFractionalNode-uint256-]: #NodesData-addFractionalNode-uint256-
[NodesData-addFullNode-uint256-]: #NodesData-addFullNode-uint256-
[NodesData-setNodeLeaving-uint256-]: #NodesData-setNodeLeaving-uint256-
[NodesData-setNodeLeft-uint256-]: #NodesData-setNodeLeft-uint256-
[NodesData-removeFractionalNode-uint256-]: #NodesData-removeFractionalNode-uint256-
[NodesData-removeFullNode-uint256-]: #NodesData-removeFullNode-uint256-
[NodesData-removeSpaceFromFractionalNode-uint256-uint256-]: #NodesData-removeSpaceFromFractionalNode-uint256-uint256-
[NodesData-removeSpaceFromFullNode-uint256-uint256-]: #NodesData-removeSpaceFromFullNode-uint256-uint256-
[NodesData-addSpaceToFractionalNode-uint256-uint256-]: #NodesData-addSpaceToFractionalNode-uint256-uint256-
[NodesData-addSpaceToFullNode-uint256-uint256-]: #NodesData-addSpaceToFullNode-uint256-uint256-
[NodesData-changeNodeLastRewardDate-uint256-]: #NodesData-changeNodeLastRewardDate-uint256-
[NodesData-isNodeExist-address-uint256-]: #NodesData-isNodeExist-address-uint256-
[NodesData-isLeavingPeriodExpired-uint256-]: #NodesData-isLeavingPeriodExpired-uint256-
[NodesData-isTimeForReward-uint256-]: #NodesData-isTimeForReward-uint256-
[NodesData-getNodeIP-uint256-]: #NodesData-getNodeIP-uint256-
[NodesData-getNodePort-uint256-]: #NodesData-getNodePort-uint256-
[NodesData-getNodePublicKey-uint256-]: #NodesData-getNodePublicKey-uint256-
[NodesData-isNodeLeaving-uint256-]: #NodesData-isNodeLeaving-uint256-
[NodesData-isNodeLeft-uint256-]: #NodesData-isNodeLeft-uint256-
[NodesData-getNodeLastRewardDate-uint256-]: #NodesData-getNodeLastRewardDate-uint256-
[NodesData-getNodeNextRewardDate-uint256-]: #NodesData-getNodeNextRewardDate-uint256-
[NodesData-getNumberOfNodes--]: #NodesData-getNumberOfNodes--
[NodesData-getNumberOfFractionalNodes--]: #NodesData-getNumberOfFractionalNodes--
[NodesData-getNumberOfFullNodes--]: #NodesData-getNumberOfFullNodes--
[NodesData-getNumberOnlineNodes--]: #NodesData-getNumberOnlineNodes--
[NodesData-getNumberOfFreeFractionalNodes-uint256-uint256-]: #NodesData-getNumberOfFreeFractionalNodes-uint256-uint256-
[NodesData-getNumberOfFreeFullNodes-uint256-]: #NodesData-getNumberOfFreeFullNodes-uint256-
[NodesData-getActiveNodeIPs--]: #NodesData-getActiveNodeIPs--
[NodesData-getActiveNodesByAddress--]: #NodesData-getActiveNodesByAddress--
[NodesData-isNodeActive-uint256-]: #NodesData-isNodeActive-uint256-
[NodesData-getActiveNodeIds--]: #NodesData-getActiveNodeIds--
[NodesData-getNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-]: #NodesData-getNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-
[NodesData-countNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-]: #NodesData-countNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-
...
## <span id="NodesData"></span> `NodesData`
...
- [`constructor(uint256 newLeavingPeriod, address newContractsAddress)`][NodesData-constructor-uint256-address-]
- [`getNodesWithFreeSpace(uint256 partOfNode, uint256 freeSpace)`][NodesData-getNodesWithFreeSpace-uint256-uint256-]
- [`addNode(address from, string name, bytes4 ip, bytes4 publicIP, uint16 port, bytes publicKey)`][NodesData-addNode-address-string-bytes4-bytes4-uint16-bytes-]
- [`addFractionalNode(uint256 nodeIndex)`][NodesData-addFractionalNode-uint256-]
- [`addFullNode(uint256 nodeIndex)`][NodesData-addFullNode-uint256-]
- [`setNodeLeaving(uint256 nodeIndex)`][NodesData-setNodeLeaving-uint256-]
- [`setNodeLeft(uint256 nodeIndex)`][NodesData-setNodeLeft-uint256-]
- [`removeFractionalNode(uint256 subarrayIndex)`][NodesData-removeFractionalNode-uint256-]
- [`removeFullNode(uint256 subarrayIndex)`][NodesData-removeFullNode-uint256-]
- [`removeSpaceFromFractionalNode(uint256 subarrayLink, uint256 space)`][NodesData-removeSpaceFromFractionalNode-uint256-uint256-]
- [`removeSpaceFromFullNode(uint256 subarrayLink, uint256 space)`][NodesData-removeSpaceFromFullNode-uint256-uint256-]
- [`addSpaceToFractionalNode(uint256 subarrayLink, uint256 space)`][NodesData-addSpaceToFractionalNode-uint256-uint256-]
- [`addSpaceToFullNode(uint256 subarrayLink, uint256 space)`][NodesData-addSpaceToFullNode-uint256-uint256-]
- [`changeNodeLastRewardDate(uint256 nodeIndex)`][NodesData-changeNodeLastRewardDate-uint256-]
- [`isNodeExist(address from, uint256 nodeIndex)`][NodesData-isNodeExist-address-uint256-]
- [`isLeavingPeriodExpired(uint256 nodeIndex)`][NodesData-isLeavingPeriodExpired-uint256-]
- [`isTimeForReward(uint256 nodeIndex)`][NodesData-isTimeForReward-uint256-]
- [`getNodeIP(uint256 nodeIndex)`][NodesData-getNodeIP-uint256-]
- [`getNodePort(uint256 nodeIndex)`][NodesData-getNodePort-uint256-]
- [`getNodePublicKey(uint256 nodeIndex)`][NodesData-getNodePublicKey-uint256-]
- [`isNodeLeaving(uint256 nodeIndex)`][NodesData-isNodeLeaving-uint256-]
- [`isNodeLeft(uint256 nodeIndex)`][NodesData-isNodeLeft-uint256-]
- [`getNodeLastRewardDate(uint256 nodeIndex)`][NodesData-getNodeLastRewardDate-uint256-]
- [`getNodeNextRewardDate(uint256 nodeIndex)`][NodesData-getNodeNextRewardDate-uint256-]
- [`getNumberOfNodes()`][NodesData-getNumberOfNodes--]
- [`getNumberOfFractionalNodes()`][NodesData-getNumberOfFractionalNodes--]
- [`getNumberOfFullNodes()`][NodesData-getNumberOfFullNodes--]
- [`getNumberOnlineNodes()`][NodesData-getNumberOnlineNodes--]
- [`getNumberOfFreeFractionalNodes(uint256 space, uint256 needNodes)`][NodesData-getNumberOfFreeFractionalNodes-uint256-uint256-]
- [`getNumberOfFreeFullNodes(uint256 needNodes)`][NodesData-getNumberOfFreeFullNodes-uint256-]
- [`getActiveNodeIPs()`][NodesData-getActiveNodeIPs--]
- [`getActiveNodesByAddress()`][NodesData-getActiveNodesByAddress--]
- [`isNodeActive(uint256 nodeIndex)`][NodesData-isNodeActive-uint256-]
- [`getActiveNodeIds()`][NodesData-getActiveNodeIds--]
- [`getNodesWithFreeSpace(struct NodesData.NodeFilling[] nodesFillings, uint256 freeSpace)`][NodesData-getNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-]
- [`countNodesWithFreeSpace(struct NodesData.NodeFilling[] nodesFillings, uint256 freeSpace)`][NodesData-countNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-]
...
### <span id="NodesData-constructor-uint256-address-"></span> `constructor(uint256 newLeavingPeriod, address newContractsAddress)` (public)



### <span id="NodesData-getNodesWithFreeSpace-uint256-uint256-"></span> `getNodesWithFreeSpace(uint256 partOfNode, uint256 freeSpace) → uint256[]` (external)



### <span id="NodesData-addNode-address-string-bytes4-bytes4-uint16-bytes-"></span> `addNode(address from, string name, bytes4 ip, bytes4 publicIP, uint16 port, bytes publicKey) → uint256` (external)

addNode - adds Node to array
function could be run only by executor


### <span id="NodesData-addFractionalNode-uint256-"></span> `addFractionalNode(uint256 nodeIndex)` (external)

addFractionalNode - adds Node to array of Fractional Nodes
function could be run only by executor


### <span id="NodesData-addFullNode-uint256-"></span> `addFullNode(uint256 nodeIndex)` (external)

addFullNode - adds Node to array of Full Nodes
function could be run only by executor


### <span id="NodesData-setNodeLeaving-uint256-"></span> `setNodeLeaving(uint256 nodeIndex)` (external)

setNodeLeaving - set Node Leaving
function could be run only by NodesFunctionality


### <span id="NodesData-setNodeLeft-uint256-"></span> `setNodeLeft(uint256 nodeIndex)` (external)

setNodeLeft - set Node Left
function could be run only by NodesFunctionality


### <span id="NodesData-removeFractionalNode-uint256-"></span> `removeFractionalNode(uint256 subarrayIndex)` (external)

removeFractionalNode - removes Node from Fractional Nodes array
function could be run only by NodesFunctionality


### <span id="NodesData-removeFullNode-uint256-"></span> `removeFullNode(uint256 subarrayIndex)` (external)

removeFullNode - removes Node from Full Nodes array
function could be run only by NodesFunctionality


### <span id="NodesData-removeSpaceFromFractionalNode-uint256-uint256-"></span> `removeSpaceFromFractionalNode(uint256 subarrayLink, uint256 space) → bool` (external)

removeSpaceFromFractionalNode - occupies space from Fractional Node
function could be run only by SchainsFunctionality


### <span id="NodesData-removeSpaceFromFullNode-uint256-uint256-"></span> `removeSpaceFromFullNode(uint256 subarrayLink, uint256 space) → bool` (external)

removeSpaceFromFullNodes - occupies space from Full Node
function could be run only by SchainsFunctionality


### <span id="NodesData-addSpaceToFractionalNode-uint256-uint256-"></span> `addSpaceToFractionalNode(uint256 subarrayLink, uint256 space)` (external)

adSpaceToFractionalNode - returns space to Fractional Node
function could be run only be SchainsFunctionality


### <span id="NodesData-addSpaceToFullNode-uint256-uint256-"></span> `addSpaceToFullNode(uint256 subarrayLink, uint256 space)` (external)

addSpaceToFullNode - returns space to Full Node
function could be run only by SchainsFunctionality


### <span id="NodesData-changeNodeLastRewardDate-uint256-"></span> `changeNodeLastRewardDate(uint256 nodeIndex)` (external)

changeNodeLastRewardDate - changes Node's last reward date
function could be run only by SkaleManager


### <span id="NodesData-isNodeExist-address-uint256-"></span> `isNodeExist(address from, uint256 nodeIndex) → bool` (external)

isNodeExist - checks existence of Node at this address


### <span id="NodesData-isLeavingPeriodExpired-uint256-"></span> `isLeavingPeriodExpired(uint256 nodeIndex) → bool` (external)

isLeavingPeriodExpired - checks expiration of leaving period of Node


### <span id="NodesData-isTimeForReward-uint256-"></span> `isTimeForReward(uint256 nodeIndex) → bool` (external)

isTimeForReward - checks if time for reward has come


### <span id="NodesData-getNodeIP-uint256-"></span> `getNodeIP(uint256 nodeIndex) → bytes4` (external)

getNodeIP - get ip address of Node


### <span id="NodesData-getNodePort-uint256-"></span> `getNodePort(uint256 nodeIndex) → uint16` (external)

getNodePort - get Node's port


### <span id="NodesData-getNodePublicKey-uint256-"></span> `getNodePublicKey(uint256 nodeIndex) → bytes` (external)



### <span id="NodesData-isNodeLeaving-uint256-"></span> `isNodeLeaving(uint256 nodeIndex) → bool` (external)

isNodeLeaving - checks if Node status Leaving


### <span id="NodesData-isNodeLeft-uint256-"></span> `isNodeLeft(uint256 nodeIndex) → bool` (external)

isNodeLeft - checks if Node status Left


### <span id="NodesData-getNodeLastRewardDate-uint256-"></span> `getNodeLastRewardDate(uint256 nodeIndex) → uint32` (external)

getNodeLastRewardDate - get Node last reward date


### <span id="NodesData-getNodeNextRewardDate-uint256-"></span> `getNodeNextRewardDate(uint256 nodeIndex) → uint32` (external)

getNodeNextRewardDate - get Node next reward date


### <span id="NodesData-getNumberOfNodes--"></span> `getNumberOfNodes() → uint256` (external)

getNumberOfNodes - get number of Nodes


### <span id="NodesData-getNumberOfFractionalNodes--"></span> `getNumberOfFractionalNodes() → uint256` (external)

getNumberOfFractionalNodes - get number of Fractional Nodes


### <span id="NodesData-getNumberOfFullNodes--"></span> `getNumberOfFullNodes() → uint256` (external)

getNumberOfFullNodes - get number of Full Nodes


### <span id="NodesData-getNumberOnlineNodes--"></span> `getNumberOnlineNodes() → uint256` (external)

getNumberOfFullNodes - get number Online Nodes


### <span id="NodesData-getNumberOfFreeFractionalNodes-uint256-uint256-"></span> `getNumberOfFreeFractionalNodes(uint256 space, uint256 needNodes) → bool nodesAreEnough` (external)

getNumberOfFreefractionalNodes - get number of free Fractional Nodes


### <span id="NodesData-getNumberOfFreeFullNodes-uint256-"></span> `getNumberOfFreeFullNodes(uint256 needNodes) → bool nodesAreEnough` (external)

getnumberOfFreeFullNodes - get number of free Full Nodes


### <span id="NodesData-getActiveNodeIPs--"></span> `getActiveNodeIPs() → bytes4[] activeNodeIPs` (external)

getActiveNodeIPs - get array of ips of Active Nodes


### <span id="NodesData-getActiveNodesByAddress--"></span> `getActiveNodesByAddress() → uint256[] activeNodesByAddress` (external)

getActiveNodesByAddress - get array of indexes of Active Nodes, which were
created by msg.sender


### <span id="NodesData-isNodeActive-uint256-"></span> `isNodeActive(uint256 nodeIndex) → bool` (public)

isNodeActive - checks if Node status Active


### <span id="NodesData-getActiveNodeIds--"></span> `getActiveNodeIds() → uint256[] activeNodeIds` (public)

getActiveNodeIds - get array of indexes of Active Nodes


### <span id="NodesData-getNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-"></span> `getNodesWithFreeSpace(struct NodesData.NodeFilling[] nodesFillings, uint256 freeSpace) → uint256[]` (internal)



### <span id="NodesData-countNodesWithFreeSpace-struct-NodesData-NodeFilling---uint256-"></span> `countNodesWithFreeSpace(struct NodesData.NodeFilling[] nodesFillings, uint256 freeSpace) → uint256 count` (internal)
