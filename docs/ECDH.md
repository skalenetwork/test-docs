...
[ECDH]: #ECDH
[ECDH-constructor--]: #ECDH-constructor--
...
## <span id="ECDH"></span> `ECDH`



- [`constructor()`][ECDH-constructor--]
- [`publicKey(uint256 privKey)`][ECDH-publicKey-uint256-]
- [`deriveKey(uint256 privKey, uint256 pubX, uint256 pubY)`][ECDH-deriveKey-uint256-uint256-uint256-]
- [`jAdd(uint256 x1, uint256 z1, uint256 x2, uint256 z2)`][ECDH-jAdd-uint256-uint256-uint256-uint256-]
- [`jSub(uint256 x1, uint256 z1, uint256 x2, uint256 z2)`][ECDH-jSub-uint256-uint256-uint256-uint256-]
- [`jMul(uint256 x1, uint256 z1, uint256 x2, uint256 z2)`][ECDH-jMul-uint256-uint256-uint256-uint256-]
- [`jDiv(uint256 x1, uint256 z1, uint256 x2, uint256 z2)`][ECDH-jDiv-uint256-uint256-uint256-uint256-]
- [`inverse(uint256 a)`][ECDH-inverse-uint256-]
- [`ecAdd(uint256 x1, uint256 y1, uint256 z1, uint256 x2, uint256 y2, uint256 z2)`][ECDH-ecAdd-uint256-uint256-uint256-uint256-uint256-uint256-]
- [`ecDouble(uint256 x1, uint256 y1, uint256 z1)`][ECDH-ecDouble-uint256-uint256-uint256-]
- [`ecMul(uint256 d, uint256 x1, uint256 y1, uint256 z1)`][ECDH-ecMul-uint256-uint256-uint256-uint256-]
### <span id="ECDH-constructor--"></span> `constructor()` (public)



### <span id="ECDH-publicKey-uint256-"></span> `publicKey(uint256 privKey) → uint256 qx, uint256 qy` (external)



### <span id="ECDH-deriveKey-uint256-uint256-uint256-"></span> `deriveKey(uint256 privKey, uint256 pubX, uint256 pubY) → uint256 qx, uint256 qy` (external)



### <span id="ECDH-jAdd-uint256-uint256-uint256-uint256-"></span> `jAdd(uint256 x1, uint256 z1, uint256 x2, uint256 z2) → uint256 x3, uint256 z3` (public)



### <span id="ECDH-jSub-uint256-uint256-uint256-uint256-"></span> `jSub(uint256 x1, uint256 z1, uint256 x2, uint256 z2) → uint256 x3, uint256 z3` (public)



### <span id="ECDH-jMul-uint256-uint256-uint256-uint256-"></span> `jMul(uint256 x1, uint256 z1, uint256 x2, uint256 z2) → uint256 x3, uint256 z3` (public)



### <span id="ECDH-jDiv-uint256-uint256-uint256-uint256-"></span> `jDiv(uint256 x1, uint256 z1, uint256 x2, uint256 z2) → uint256 x3, uint256 z3` (public)



### <span id="ECDH-inverse-uint256-"></span> `inverse(uint256 a) → uint256 invA` (public)



### <span id="ECDH-ecAdd-uint256-uint256-uint256-uint256-uint256-uint256-"></span> `ecAdd(uint256 x1, uint256 y1, uint256 z1, uint256 x2, uint256 y2, uint256 z2) → uint256 x3, uint256 y3, uint256 z3` (public)



### <span id="ECDH-ecDouble-uint256-uint256-uint256-"></span> `ecDouble(uint256 x1, uint256 y1, uint256 z1) → uint256 x3, uint256 y3, uint256 z3` (public)



### <span id="ECDH-ecMul-uint256-uint256-uint256-uint256-"></span> `ecMul(uint256 d, uint256 x1, uint256 y1, uint256 z1) → uint256 x3, uint256 y3, uint256 z3` (public)
