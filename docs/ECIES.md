...
[AES]: #AES
[AES-isInitialized--]: #AES-isInitialized--
[AES-constructor-uint16-]: #AES-constructor-uint16-
[AES-setSbox--]: #AES-setSbox--
[AES-setInvSbox--]: #AES-setInvSbox--
[AES-encrypt-string-bytes-]: #AES-encrypt-string-bytes-
[AES-decrypt-bytes-bytes-]: #AES-decrypt-bytes-bytes-
[AES-encrypt1-bytes-bytes-]: #AES-encrypt1-bytes-bytes-
[AES-decrypt1-bytes-bytes-]: #AES-decrypt1-bytes-bytes-
[AES-keyExpansion-bytes-]: #AES-keyExpansion-bytes-
[AES-addRoundKey-bytes-bytes-]: #AES-addRoundKey-bytes-bytes-
[AES-subBytes-bytes-]: #AES-subBytes-bytes-
[AES-invSubBytes-bytes-]: #AES-invSubBytes-bytes-
[AES-shiftRows-bytes-]: #AES-shiftRows-bytes-
[AES-invShiftRows-bytes-]: #AES-invShiftRows-bytes-
[AES-mixColumns-bytes-]: #AES-mixColumns-bytes-
[AES-invMixColumns-bytes-]: #AES-invMixColumns-bytes-
[AES-getByteFromSbox-bytes1-]: #AES-getByteFromSbox-bytes1-
[AES-getByteFromInvSbox-bytes1-]: #AES-getByteFromInvSbox-bytes1-
[AES-mulBy02-bytes1-]: #AES-mulBy02-bytes1-
[AES-mulBy03-bytes1-]: #AES-mulBy03-bytes1-
[AES-mulBy09-bytes1-]: #AES-mulBy09-bytes1-
[AES-mulBy0b-bytes1-]: #AES-mulBy0b-bytes1-
[AES-mulBy0d-bytes1-]: #AES-mulBy0d-bytes1-
[AES-mulBy0e-bytes1-]: #AES-mulBy0e-bytes1-
[AES-Encrypted-bytes-]: #AES-Encrypted-bytes-
[AES-Decrypted-string-]: #AES-Decrypted-string-
...
## <span id="AES"></span> `AES`



- [`isInitialized()`][AES-isInitialized--]
- [`constructor(uint16 typeOfAES)`][AES-constructor-uint16-]
- [`setSbox()`][AES-setSbox--]
- [`setInvSbox()`][AES-setInvSbox--]
- [`encrypt(string plainText, bytes key)`][AES-encrypt-string-bytes-]
- [`decrypt(bytes cipherText, bytes key)`][AES-decrypt-bytes-bytes-]
- [`encrypt1(bytes plainText, bytes cipherKey)`][AES-encrypt1-bytes-bytes-]
- [`decrypt1(bytes cipherText, bytes cipherKey)`][AES-decrypt1-bytes-bytes-]
- [`keyExpansion(bytes cipherKey)`][AES-keyExpansion-bytes-]
- [`addRoundKey(bytes input, bytes roundKey)`][AES-addRoundKey-bytes-bytes-]
- [`subBytes(bytes input)`][AES-subBytes-bytes-]
- [`invSubBytes(bytes input)`][AES-invSubBytes-bytes-]
- [`shiftRows(bytes input)`][AES-shiftRows-bytes-]
- [`invShiftRows(bytes input)`][AES-invShiftRows-bytes-]
- [`mixColumns(bytes input)`][AES-mixColumns-bytes-]
- [`invMixColumns(bytes input)`][AES-invMixColumns-bytes-]
- [`getByteFromSbox(bytes1 input)`][AES-getByteFromSbox-bytes1-]
- [`getByteFromInvSbox(bytes1 input)`][AES-getByteFromInvSbox-bytes1-]
- [`mulBy02(bytes1 input)`][AES-mulBy02-bytes1-]
- [`mulBy03(bytes1 input)`][AES-mulBy03-bytes1-]
- [`mulBy09(bytes1 input)`][AES-mulBy09-bytes1-]
- [`mulBy0b(bytes1 input)`][AES-mulBy0b-bytes1-]
- [`mulBy0d(bytes1 input)`][AES-mulBy0d-bytes1-]
- [`mulBy0e(bytes1 input)`][AES-mulBy0e-bytes1-]
- [`Encrypted(bytes)`][AES-Encrypted-bytes-]
- [`Decrypted(string)`][AES-Decrypted-string-]
### <span id="AES-isInitialized--"></span> `isInitialized()`



### <span id="AES-constructor-uint16-"></span> `constructor(uint16 typeOfAES)` (public)



### <span id="AES-setSbox--"></span> `setSbox()` (external)



### <span id="AES-setInvSbox--"></span> `setInvSbox()` (external)



### <span id="AES-encrypt-string-bytes-"></span> `encrypt(string plainText, bytes key) → bytes` (external)



### <span id="AES-decrypt-bytes-bytes-"></span> `decrypt(bytes cipherText, bytes key) → string newPlainText` (external)



### <span id="AES-encrypt1-bytes-bytes-"></span> `encrypt1(bytes plainText, bytes cipherKey) → bytes` (public)



### <span id="AES-decrypt1-bytes-bytes-"></span> `decrypt1(bytes cipherText, bytes cipherKey) → bytes plainText` (public)



### <span id="AES-keyExpansion-bytes-"></span> `keyExpansion(bytes cipherKey) → bytes keySchedule` (public)



### <span id="AES-addRoundKey-bytes-bytes-"></span> `addRoundKey(bytes input, bytes roundKey) → bytes` (public)



### <span id="AES-subBytes-bytes-"></span> `subBytes(bytes input) → bytes output` (public)



### <span id="AES-invSubBytes-bytes-"></span> `invSubBytes(bytes input) → bytes output` (public)



### <span id="AES-shiftRows-bytes-"></span> `shiftRows(bytes input) → bytes output` (public)



### <span id="AES-invShiftRows-bytes-"></span> `invShiftRows(bytes input) → bytes output` (public)



### <span id="AES-mixColumns-bytes-"></span> `mixColumns(bytes input) → bytes output` (public)



### <span id="AES-invMixColumns-bytes-"></span> `invMixColumns(bytes input) → bytes output` (public)



### <span id="AES-getByteFromSbox-bytes1-"></span> `getByteFromSbox(bytes1 input) → bytes1` (internal)



### <span id="AES-getByteFromInvSbox-bytes1-"></span> `getByteFromInvSbox(bytes1 input) → bytes1` (internal)



### <span id="AES-mulBy02-bytes1-"></span> `mulBy02(bytes1 input) → bytes1` (internal)



### <span id="AES-mulBy03-bytes1-"></span> `mulBy03(bytes1 input) → bytes1` (internal)



### <span id="AES-mulBy09-bytes1-"></span> `mulBy09(bytes1 input) → bytes1` (internal)



### <span id="AES-mulBy0b-bytes1-"></span> `mulBy0b(bytes1 input) → bytes1` (internal)



### <span id="AES-mulBy0d-bytes1-"></span> `mulBy0d(bytes1 input) → bytes1` (internal)



### <span id="AES-mulBy0e-bytes1-"></span> `mulBy0e(bytes1 input) → bytes1` (internal)



### <span id="AES-Encrypted-bytes-"></span> `Encrypted(bytes)`



### <span id="AES-Decrypted-string-"></span> `Decrypted(string)`
