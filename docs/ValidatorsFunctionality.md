...
[IValidatorsData]: #IValidatorsData
[IValidatorsData-addValidatedNode-bytes32-bytes32-]: #IValidatorsData-addValidatedNode-bytes32-bytes32-
[IValidatorsData-addVerdict-bytes32-uint32-uint32-]: #IValidatorsData-addVerdict-bytes32-uint32-uint32-
[IValidatorsData-removeValidatedNode-bytes32-uint256-]: #IValidatorsData-removeValidatedNode-bytes32-uint256-
[IValidatorsData-removeAllValidatedNodes-bytes32-]: #IValidatorsData-removeAllValidatedNodes-bytes32-
[IValidatorsData-removeAllVerdicts-bytes32-]: #IValidatorsData-removeAllVerdicts-bytes32-
[IValidatorsData-getValidatedArray-bytes32-]: #IValidatorsData-getValidatedArray-bytes32-
[IValidatorsData-getLengthOfMetrics-bytes32-]: #IValidatorsData-getLengthOfMetrics-bytes32-
[IValidatorsData-verdicts-bytes32-uint256-uint256-]: #IValidatorsData-verdicts-bytes32-uint256-uint256-
[ValidatorsFunctionality]: #ValidatorsFunctionality
...
[ValidatorsFunctionality-constructor-string-string-address-]: #ValidatorsFunctionality-constructor-string-string-address-
[ValidatorsFunctionality-addValidator-uint256-]: #ValidatorsFunctionality-addValidator-uint256-
[ValidatorsFunctionality-upgradeValidator-uint256-]: #ValidatorsFunctionality-upgradeValidator-uint256-
[ValidatorsFunctionality-deleteValidatorByRoot-uint256-]: #ValidatorsFunctionality-deleteValidatorByRoot-uint256-
[ValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-]: #ValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-
[ValidatorsFunctionality-calculateMetrics-uint256-]: #ValidatorsFunctionality-calculateMetrics-uint256-
[ValidatorsFunctionality-rotateNode-bytes32-]: #ValidatorsFunctionality-rotateNode-bytes32-
[ValidatorsFunctionality-selectNodeToGroup-bytes32-]: #ValidatorsFunctionality-selectNodeToGroup-bytes32-
[ValidatorsFunctionality-generateGroup-bytes32-]: #ValidatorsFunctionality-generateGroup-bytes32-
[ValidatorsFunctionality-median-uint32---]: #ValidatorsFunctionality-median-uint32---
[ValidatorsFunctionality-setNumberOfNodesInGroup-bytes32-bytes32-]: #ValidatorsFunctionality-setNumberOfNodesInGroup-bytes32-bytes32-
[ValidatorsFunctionality-comparator-bytes32-uint256-]: #ValidatorsFunctionality-comparator-bytes32-uint256-
[ValidatorsFunctionality-setValidators-bytes32-uint256-]: #ValidatorsFunctionality-setValidators-bytes32-uint256-
[ValidatorsFunctionality-find-bytes32-uint256-]: #ValidatorsFunctionality-find-bytes32-uint256-
[ValidatorsFunctionality-quickSort-uint32---uint256-uint256-]: #ValidatorsFunctionality-quickSort-uint32---uint256-uint256-
[ValidatorsFunctionality-getDataFromBytes-bytes32-]: #ValidatorsFunctionality-getDataFromBytes-bytes32-
[ValidatorsFunctionality-getDataToBytes-uint256-]: #ValidatorsFunctionality-getDataToBytes-uint256-
...
[ValidatorsFunctionality-ValidatorCreated-uint256-bytes32-uint256-uint32-uint256-]: #ValidatorsFunctionality-ValidatorCreated-uint256-bytes32-uint256-uint32-uint256-
[ValidatorsFunctionality-ValidatorUpgraded-uint256-bytes32-uint256-uint32-uint256-]: #ValidatorsFunctionality-ValidatorUpgraded-uint256-bytes32-uint256-uint32-uint256-
[ValidatorsFunctionality-ValidatorsArray-uint256-bytes32-uint256---uint32-uint256-]: #ValidatorsFunctionality-ValidatorsArray-uint256-bytes32-uint256---uint32-uint256-
[ValidatorsFunctionality-VerdictWasSent-uint256-uint256-uint32-uint32-bool-uint32-uint256-]: #ValidatorsFunctionality-VerdictWasSent-uint256-uint256-uint32-uint32-bool-uint32-uint256-
[ValidatorsFunctionality-MetricsWereCalculated-uint256-uint32-uint32-uint32-uint256-]: #ValidatorsFunctionality-MetricsWereCalculated-uint256-uint32-uint32-uint32-uint256-
[ValidatorsFunctionality-PeriodsWereSet-uint256-uint256-uint32-uint256-]: #ValidatorsFunctionality-PeriodsWereSet-uint256-uint256-uint32-uint256-
[ValidatorsFunctionality-ValidatorRotated-bytes32-uint256-]: #ValidatorsFunctionality-ValidatorRotated-bytes32-uint256-
...
## <span id="ValidatorsFunctionality"></span> `ValidatorsFunctionality`
...
- [`constructor(string newExecutorName, string newDataName, address newContractsAddress)`][ValidatorsFunctionality-constructor-string-string-address-]
- [`addValidator(uint256 nodeIndex)`][ValidatorsFunctionality-addValidator-uint256-]
- [`upgradeValidator(uint256 nodeIndex)`][ValidatorsFunctionality-upgradeValidator-uint256-]
- [`deleteValidatorByRoot(uint256 nodeIndex)`][ValidatorsFunctionality-deleteValidatorByRoot-uint256-]
- [`sendVerdict(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency)`][ValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-]
- [`calculateMetrics(uint256 nodeIndex)`][ValidatorsFunctionality-calculateMetrics-uint256-]
- [`rotateNode(bytes32 schainId)`][ValidatorsFunctionality-rotateNode-bytes32-]
- [`selectNodeToGroup(bytes32 groupIndex)`][ValidatorsFunctionality-selectNodeToGroup-bytes32-]
- [`generateGroup(bytes32 groupIndex)`][ValidatorsFunctionality-generateGroup-bytes32-]
- [`median(uint32[] values)`][ValidatorsFunctionality-median-uint32---]
- [`setNumberOfNodesInGroup(bytes32 groupIndex, bytes32 groupData)`][ValidatorsFunctionality-setNumberOfNodesInGroup-bytes32-bytes32-]
- [`comparator(bytes32 groupIndex, uint256 indexOfNode)`][ValidatorsFunctionality-comparator-bytes32-uint256-]
- [`setValidators(bytes32 groupIndex, uint256 nodeIndex)`][ValidatorsFunctionality-setValidators-bytes32-uint256-]
- [`find(bytes32 validatorIndex, uint256 nodeIndex)`][ValidatorsFunctionality-find-bytes32-uint256-]
- [`quickSort(uint32[] array, uint256 left, uint256 right)`][ValidatorsFunctionality-quickSort-uint32---uint256-uint256-]
- [`getDataFromBytes(bytes32 data)`][ValidatorsFunctionality-getDataFromBytes-bytes32-]
- [`getDataToBytes(uint256 nodeIndex)`][ValidatorsFunctionality-getDataToBytes-uint256-]
...
- [`ValidatorCreated(uint256 nodeIndex, bytes32 groupIndex, uint256 numberOfValidators, uint32 time, uint256 gasSpend)`][ValidatorsFunctionality-ValidatorCreated-uint256-bytes32-uint256-uint32-uint256-]
- [`ValidatorUpgraded(uint256 nodeIndex, bytes32 groupIndex, uint256 numberOfValidators, uint32 time, uint256 gasSpend)`][ValidatorsFunctionality-ValidatorUpgraded-uint256-bytes32-uint256-uint32-uint256-]
- [`ValidatorsArray(uint256 nodeIndex, bytes32 groupIndex, uint256[] nodesInGroup, uint32 time, uint256 gasSpend)`][ValidatorsFunctionality-ValidatorsArray-uint256-bytes32-uint256---uint32-uint256-]
- [`VerdictWasSent(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency, bool status, uint32 time, uint256 gasSpend)`][ValidatorsFunctionality-VerdictWasSent-uint256-uint256-uint32-uint32-bool-uint32-uint256-]
- [`MetricsWereCalculated(uint256 forNodeIndex, uint32 averageDowntime, uint32 averageLatency, uint32 time, uint256 gasSpend)`][ValidatorsFunctionality-MetricsWereCalculated-uint256-uint32-uint32-uint32-uint256-]
- [`PeriodsWereSet(uint256 rewardPeriod, uint256 deltaPeriod, uint32 time, uint256 gasSpend)`][ValidatorsFunctionality-PeriodsWereSet-uint256-uint256-uint32-uint256-]
- [`ValidatorRotated(bytes32 groupIndex, uint256 newNode)`][ValidatorsFunctionality-ValidatorRotated-bytes32-uint256-]
...
### <span id="ValidatorsFunctionality-constructor-string-string-address-"></span> `constructor(string newExecutorName, string newDataName, address newContractsAddress)` (public)



### <span id="ValidatorsFunctionality-addValidator-uint256-"></span> `addValidator(uint256 nodeIndex)` (external)



### <span id="ValidatorsFunctionality-upgradeValidator-uint256-"></span> `upgradeValidator(uint256 nodeIndex)` (external)



### <span id="ValidatorsFunctionality-deleteValidatorByRoot-uint256-"></span> `deleteValidatorByRoot(uint256 nodeIndex)` (external)



### <span id="ValidatorsFunctionality-sendVerdict-uint256-uint256-uint32-uint32-"></span> `sendVerdict(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency)` (external)



### <span id="ValidatorsFunctionality-calculateMetrics-uint256-"></span> `calculateMetrics(uint256 nodeIndex) → uint32 averageDowntime, uint32 averageLatency` (external)



### <span id="ValidatorsFunctionality-rotateNode-bytes32-"></span> `rotateNode(bytes32 schainId)` (external)



### <span id="ValidatorsFunctionality-selectNodeToGroup-bytes32-"></span> `selectNodeToGroup(bytes32 groupIndex) → bytes32, uint256` (internal)



### <span id="ValidatorsFunctionality-generateGroup-bytes32-"></span> `generateGroup(bytes32 groupIndex) → uint256[]` (internal)



### <span id="ValidatorsFunctionality-median-uint32---"></span> `median(uint32[] values) → uint32` (internal)



### <span id="ValidatorsFunctionality-setNumberOfNodesInGroup-bytes32-bytes32-"></span> `setNumberOfNodesInGroup(bytes32 groupIndex, bytes32 groupData) → uint256 numberOfNodes, uint256 finish` (internal)



### <span id="ValidatorsFunctionality-comparator-bytes32-uint256-"></span> `comparator(bytes32 groupIndex, uint256 indexOfNode) → bool` (internal)



### <span id="ValidatorsFunctionality-setValidators-bytes32-uint256-"></span> `setValidators(bytes32 groupIndex, uint256 nodeIndex) → uint256` (internal)



### <span id="ValidatorsFunctionality-find-bytes32-uint256-"></span> `find(bytes32 validatorIndex, uint256 nodeIndex) → uint256 index, uint32 time` (internal)



### <span id="ValidatorsFunctionality-quickSort-uint32---uint256-uint256-"></span> `quickSort(uint32[] array, uint256 left, uint256 right)` (internal)



### <span id="ValidatorsFunctionality-getDataFromBytes-bytes32-"></span> `getDataFromBytes(bytes32 data) → uint256 index, uint32 time` (internal)



### <span id="ValidatorsFunctionality-getDataToBytes-uint256-"></span> `getDataToBytes(uint256 nodeIndex) → bytes32 bytesParameters` (internal)



### <span id="ValidatorsFunctionality-ValidatorCreated-uint256-bytes32-uint256-uint32-uint256-"></span> `ValidatorCreated(uint256 nodeIndex, bytes32 groupIndex, uint256 numberOfValidators, uint32 time, uint256 gasSpend)`



### <span id="ValidatorsFunctionality-ValidatorUpgraded-uint256-bytes32-uint256-uint32-uint256-"></span> `ValidatorUpgraded(uint256 nodeIndex, bytes32 groupIndex, uint256 numberOfValidators, uint32 time, uint256 gasSpend)`



### <span id="ValidatorsFunctionality-ValidatorsArray-uint256-bytes32-uint256---uint32-uint256-"></span> `ValidatorsArray(uint256 nodeIndex, bytes32 groupIndex, uint256[] nodesInGroup, uint32 time, uint256 gasSpend)`



### <span id="ValidatorsFunctionality-VerdictWasSent-uint256-uint256-uint32-uint32-bool-uint32-uint256-"></span> `VerdictWasSent(uint256 fromValidatorIndex, uint256 toNodeIndex, uint32 downtime, uint32 latency, bool status, uint32 time, uint256 gasSpend)`



### <span id="ValidatorsFunctionality-MetricsWereCalculated-uint256-uint32-uint32-uint32-uint256-"></span> `MetricsWereCalculated(uint256 forNodeIndex, uint32 averageDowntime, uint32 averageLatency, uint32 time, uint256 gasSpend)`



### <span id="ValidatorsFunctionality-PeriodsWereSet-uint256-uint256-uint32-uint256-"></span> `PeriodsWereSet(uint256 rewardPeriod, uint256 deltaPeriod, uint32 time, uint256 gasSpend)`



### <span id="ValidatorsFunctionality-ValidatorRotated-bytes32-uint256-"></span> `ValidatorRotated(bytes32 groupIndex, uint256 newNode)`
